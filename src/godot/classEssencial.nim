...
proc bind_virtuals*(S: typedesc[MultiplayerAPIExtension]; T: typedesc) =
  ...
  table["_object_configuration_add"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[MultiplayerAPIExtension](p_instance).objectConfigurationAdd(p_args[0].decode(Object), p_args[1].decode(ptr Variant)).encode(r_ret)
  table["_object_configuration_remove"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[MultiplayerAPIExtension](p_instance).objectConfigurationRemove(p_args[0].decode(Object), p_args[1].decode(ptr Variant)).encode(r_ret)
...
method commitHandle*(self: EditorNode3DGizmo; id: int32; secondary: Bool; restore: ptr Variant; cancel: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorNode3DGizmo]; T: typedesc) =
  ...
  table["_commit_handle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmo](p_instance).commitHandle(p_args[0].decode(int32), p_args[1].decode(Bool), p_args[2].decode(ptr Variant), p_args[3].decode(Bool))
...
method commitHandle*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool; restore: ptr Variant; cancel: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorNode3DGizmoPlugin]; T: typedesc) =
  ...
  table["_commit_handle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).commitHandle(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool), p_args[3].decode(ptr Variant), p_args[4].decode(Bool))
...
method shapedTextAddString*(self: TextServerExtension; shaped: RID; text: String; fonts: TypedArray[RID]; size: int64; opentypeFeatures: Dictionary; language: String; meta: ptr Variant): Bool {.base.} = (discard)
method shapedTextAddObject*(self: TextServerExtension; shaped: RID; key: ptr Variant; size: Vector2; inlineAlign: InlineAlignment; length: int64; baseline: float64): Bool {.base.} = (discard)
method shapedTextResizeObject*(self: TextServerExtension; shaped: RID; key: ptr Variant; size: Vector2; inlineAlign: InlineAlignment; baseline: float64): Bool {.base.} = (discard)
...
method shapedTextGetObjectRect*(self: TextServerExtension; shaped: RID; key: ptr Variant): Rect2 {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[TextServerExtension]; T: typedesc) =
  ...
  table["_shaped_text_add_string"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextAddString(p_args[0].decode(RID), p_args[1].decode(String), p_args[2].decode(TypedArray[RID]), p_args[3].decode(int64), p_args[4].decode(Dictionary), p_args[5].decode(String), p_args[6].decode(ptr Variant)).encode(r_ret)
  table["_shaped_text_add_object"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextAddObject(p_args[0].decode(RID), p_args[1].decode(ptr Variant), p_args[2].decode(Vector2), p_args[3].decode(InlineAlignment), p_args[4].decode(int64), p_args[5].decode(float64)).encode(r_ret)
  table["_shaped_text_resize_object"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextResizeObject(p_args[0].decode(RID), p_args[1].decode(ptr Variant), p_args[2].decode(Vector2), p_args[3].decode(InlineAlignment), p_args[4].decode(float64)).encode(r_ret)
  ...
  table["_shaped_text_get_object_rect"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetObjectRect(p_args[0].decode(RID), p_args[1].decode(ptr Variant)).encode(r_ret)
