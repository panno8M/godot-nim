...
method postProcessKeyValue*(self: AnimationPlayer; animation: Ref[Animation]; track: int32; value: ptr Variant; `object`: Object; objectIdx: int32): Variant {.base.} = (discard)
proc bind_virtuals*(S: typedesc[AnimationPlayer]; T: typedesc) =
  S.Inherit.bind_virtuals(T)
  let table = get_userdata(T).virtualMethods
  table["_post_process_key_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AnimationPlayer](p_instance).postProcessKeyValue(p_args[0].decode(Ref[Animation]), p_args[1].decode(int32), p_args[2].decode(ptr Variant), p_args[3].decode(Object), p_args[4].decode(int32)).encode(r_ret)

method postProcessKeyValue*(self: AnimationTree; animation: Ref[Animation]; track: int32; value: ptr Variant; `object`: Object; objectIdx: int32): Variant {.base.} = (discard)
...
method customizeScene*(self: Ref[EditorExportPlugin]; scene: Node; path: String): Node {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorExportPlugin]; T: typedesc) =
  ...
  table["_customize_scene"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorExportPlugin]](p_instance).customizeScene(p_args[0].decode(Node), p_args[1].decode(String)).encode(r_ret)
...
method canHandle*(self: Ref[EditorInspectorPlugin]; `object`: Object): Bool {.base.} = (discard)
method parseBegin*(self: Ref[EditorInspectorPlugin]; `object`: Object) {.base.} = (discard)
method parseCategory*(self: Ref[EditorInspectorPlugin]; `object`: Object; category: String) {.base.} = (discard)
method parseGroup*(self: Ref[EditorInspectorPlugin]; `object`: Object; group: String) {.base.} = (discard)
method parseProperty*(self: Ref[EditorInspectorPlugin]; `object`: Object; `type`: Variant_Type; name: String; hintType: PropertyHint; hintString: String; usageFlags: set[PropertyUsageFlags]; wide: Bool): Bool {.base.} = (discard)
method parseEnd*(self: Ref[EditorInspectorPlugin]; `object`: Object) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[EditorInspectorPlugin]; T: typedesc) =
  S.Inherit.bind_virtuals(T)
  let table = get_userdata(T).virtualMethods
  table["_can_handle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorInspectorPlugin]](p_instance).canHandle(p_args[0].decode(Object)).encode(r_ret)
  table["_parse_begin"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorInspectorPlugin]](p_instance).parseBegin(p_args[0].decode(Object))
  table["_parse_category"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorInspectorPlugin]](p_instance).parseCategory(p_args[0].decode(Object), p_args[1].decode(String))
  table["_parse_group"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorInspectorPlugin]](p_instance).parseGroup(p_args[0].decode(Object), p_args[1].decode(String))
  ...
  table["_parse_end"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorInspectorPlugin]](p_instance).parseEnd(p_args[0].decode(Object))
...
method postImport*(self: Ref[EditorScenePostImport]; scene: Node): Object {.base.} = (discard)
proc bind_virtuals*(S: typedesc[EditorScenePostImport]; T: typedesc) =
  S.Inherit.bind_virtuals(T)
  let table = get_userdata(T).virtualMethods
  table["_post_import"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorScenePostImport]](p_instance).postImport(p_args[0].decode(Node)).encode(r_ret)
...
method internalProcess*(self: Ref[EditorScenePostImportPlugin]; category: int32; baseNode: Node; node: Node; resource: Ref[Resource]) {.base.} = (discard)
...
method preProcess*(self: Ref[EditorScenePostImportPlugin]; scene: Node) {.base.} = (discard)
method postProcess*(self: Ref[EditorScenePostImportPlugin]; scene: Node) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[EditorScenePostImportPlugin]; T: typedesc) =
  ...
  table["_internal_process"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorScenePostImportPlugin]](p_instance).internalProcess(p_args[0].decode(int32), p_args[1].decode(Node), p_args[2].decode(Node), p_args[3].decode(Ref[Resource]))
  ...
  table["_pre_process"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorScenePostImportPlugin]](p_instance).preProcess(p_args[0].decode(Node))
  table["_post_process"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[EditorScenePostImportPlugin]](p_instance).postProcess(p_args[0].decode(Node))
...
method rpc*(self: Ref[MultiplayerAPIExtension]; peer: int32; `object`: Object; `method`: StringName; args: Array): Error {.base.} = (discard)
method getRemoteSenderId*(self: Ref[MultiplayerAPIExtension]): int32 {.base.} = (discard)
method objectConfigurationAdd*(self: Ref[MultiplayerAPIExtension]; `object`: Object; configuration: ptr Variant): Error {.base.} = (discard)
method objectConfigurationRemove*(self: Ref[MultiplayerAPIExtension]; `object`: Object; configuration: ptr Variant): Error {.base.} = (discard)
proc bind_virtuals*(S: typedesc[MultiplayerAPIExtension]; T: typedesc) =
  ...
  table["_rpc"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[MultiplayerAPIExtension]](p_instance).rpc(p_args[0].decode(int32), p_args[1].decode(Object), p_args[2].decode(StringName), p_args[3].decode(Array)).encode(r_ret)
  ...
  table["_object_configuration_add"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[MultiplayerAPIExtension]](p_instance).objectConfigurationAdd(p_args[0].decode(Object), p_args[1].decode(ptr Variant)).encode(r_ret)
  table["_object_configuration_remove"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[MultiplayerAPIExtension]](p_instance).objectConfigurationRemove(p_args[0].decode(Object), p_args[1].decode(ptr Variant)).encode(r_ret)
...
method generateSceneNode*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; gltfNode: Ref[GLTFNode]; sceneParent: Node): Node3D {.base.} = (discard)
method importPostParse*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]): Error {.base.} = (discard)
method importNode*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; gltfNode: Ref[GLTFNode]; json: Dictionary; node: Node): Error {.base.} = (discard)
method importPost*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; root: Node): Error {.base.} = (discard)
method exportPreflight*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; root: Node): Error {.base.} = (discard)
method convertSceneNode*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; gltfNode: Ref[GLTFNode]; sceneNode: Node) {.base.} = (discard)
method exportNode*(self: Ref[GLTFDocumentExtension]; state: Ref[GLTFState]; gltfNode: Ref[GLTFNode]; json: Dictionary; node: Node): Error {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[GLTFDocumentExtension]; T: typedesc) =
  ...
  table["_generate_scene_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).generateSceneNode(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Ref[GLTFNode]), p_args[2].decode(Node)).encode(r_ret)
  ...
  table["_import_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).importNode(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Ref[GLTFNode]), p_args[2].decode(Dictionary), p_args[3].decode(Node)).encode(r_ret)
  table["_import_post"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).importPost(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Node)).encode(r_ret)
  table["_export_preflight"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).exportPreflight(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Node)).encode(r_ret)
  table["_convert_scene_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).convertSceneNode(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Ref[GLTFNode]), p_args[2].decode(Node))
  table["_export_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[GLTFDocumentExtension]](p_instance).exportNode(p_args[0].decode(Ref[GLTFState]), p_args[1].decode(Ref[GLTFNode]), p_args[2].decode(Dictionary), p_args[3].decode(Node)).encode(r_ret)
...
method instanceCreate*(self: Ref[ScriptExtension]; forObject: Object): pointer {.base.} = (discard)
method placeholderInstanceCreate*(self: Ref[ScriptExtension]; forObject: Object): pointer {.base.} = (discard)
method instanceHas*(self: Ref[ScriptExtension]; `object`: Object): Bool {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ScriptExtension]; T: typedesc) =
  ...
  table["_instance_create"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[ScriptExtension]](p_instance).instanceCreate(p_args[0].decode(Object)).encode(r_ret)
  table["_placeholder_instance_create"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[ScriptExtension]](p_instance).placeholderInstanceCreate(p_args[0].decode(Object)).encode(r_ret)
  table["_instance_has"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Ref[ScriptExtension]](p_instance).instanceHas(p_args[0].decode(Object)).encode(r_ret)
