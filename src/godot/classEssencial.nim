...
proc bind_virtuals*(S: typedesc[MovieWriter]; T: typedesc) =
  ...
  table["_write_frame"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[MovieWriter](p_instance).writeFrame(p_args[0].decode(Image), p_args[1].decode(pointer)).encode(r_ret)
...
method input*(self: Node; event: InputEvent) {.base.} = (discard)
method shortcutInput*(self: Node; event: InputEvent) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[Node]; T: typedesc) =
  ...
  table["_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Node](p_instance).input(p_args[0].decode(InputEvent))
  table["_shortcut_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Node](p_instance).shortcutInput(p_args[0].decode(InputEvent))
  table["_unhandled_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Node](p_instance).unhandledInput(p_args[0].decode(InputEvent))
  table["_unhandled_key_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Node](p_instance).unhandledKeyInput(p_args[0].decode(InputEvent))
...
method postProcessKeyValue*(self: AnimationPlayer; animation: Animation; track: int32; value: Variant; `object`: Object; objectIdx: int32): Variant {.base.} = (discard)
proc bind_virtuals*(S: typedesc[AnimationPlayer]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_post_process_key_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AnimationPlayer](p_instance).postProcessKeyValue(p_args[0].decode(Animation), p_args[1].decode(int32), p_args[2].decode(Variant), p_args[3].decode(Object), p_args[4].decode(int32)).encode(r_ret)

method postProcessKeyValue*(self: AnimationTree; animation: Animation; track: int32; value: Variant; `object`: Object; objectIdx: int32): Variant {.base.} = (discard)
proc bind_virtuals*(S: typedesc[AnimationTree]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_post_process_key_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AnimationTree](p_instance).postProcessKeyValue(p_args[0].decode(Animation), p_args[1].decode(int32), p_args[2].decode(Variant), p_args[3].decode(Object), p_args[4].decode(int32)).encode(r_ret)
...
method forwardCanvasGuiInput*(self: EditorPlugin; event: InputEvent): Bool {.base.} = (discard)
...
method forward3dGuiInput*(self: EditorPlugin; viewportCamera: Camera3D; event: InputEvent): int32 {.base.} = (discard)
...
method getPluginIcon*(self: EditorPlugin): Texture2D {.base.} = (discard)
...
method setWindowLayout*(self: EditorPlugin; configuration: ConfigFile) {.base.} = (discard)
method getWindowLayout*(self: EditorPlugin; configuration: ConfigFile) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorPlugin]; T: typedesc) =
  ...
  table["_forward_3d_gui_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorPlugin](p_instance).forward3dGuiInput(p_args[0].decode(Camera3D), p_args[1].decode(InputEvent)).encode(r_ret)
  ...
  table["_set_window_layout"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorPlugin](p_instance).setWindowLayout(p_args[0].decode(ConfigFile))
  table["_get_window_layout"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorPlugin](p_instance).getWindowLayout(p_args[0].decode(ConfigFile))
...
method beginCustomizeResources*(self: EditorExportPlugin; platform: EditorExportPlatform; features: PackedStringArray): Bool {.base.} = (discard)
method customizeResource*(self: EditorExportPlugin; resource: Resource; path: String): Resource {.base.} = (discard)
method beginCustomizeScenes*(self: EditorExportPlugin; platform: EditorExportPlatform; features: PackedStringArray): Bool {.base.} = (discard)
...
method getExportOptions*(self: EditorExportPlugin; platform: EditorExportPlatform): TypedArray[Dictionary] {.base.} = (discard)
method shouldUpdateExportOptions*(self: EditorExportPlugin; platform: EditorExportPlatform): Bool {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorExportPlugin]; T: typedesc) =
  ...
  table["_begin_customize_resources"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).beginCustomizeResources(p_args[0].decode(EditorExportPlatform), p_args[1].decode(PackedStringArray)).encode(r_ret)
  table["_customize_resource"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).customizeResource(p_args[0].decode(Resource), p_args[1].decode(String)).encode(r_ret)
  table["_begin_customize_scenes"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).beginCustomizeScenes(p_args[0].decode(EditorExportPlatform), p_args[1].decode(PackedStringArray)).encode(r_ret)
  ...
  table["_get_export_options"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getExportOptions(p_args[0].decode(EditorExportPlatform)).encode(r_ret)
  table["_should_update_export_options"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).shouldUpdateExportOptions(p_args[0].decode(EditorExportPlatform)).encode(r_ret)
  table["_get_export_features"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getExportFeatures(p_args[0].decode(EditorExportPlatform), p_args[1].decode(Bool)).encode(r_ret)
...
proc bind_virtuals*(S: typedesc[EditorResourceConversionPlugin]; T: typedesc) =
  ...
  table["_convert"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorResourceConversionPlugin](p_instance).convert(p_args[0].decode(Resource)).encode(r_ret)

method handles*(self: EditorResourcePreviewGenerator; `type`: String): Bool {.base.} = (discard)
method generate*(self: EditorResourcePreviewGenerator; resource: Resource; size: Vector2i; metadata: Dictionary): Texture2D {.base.} = (discard)
method generateFromPath*(self: EditorResourcePreviewGenerator; path: String; size: Vector2i; metadata: Dictionary): Texture2D {.base.} = (discard)
...
method internalProcess*(self: EditorScenePostImportPlugin; category: int32; baseNode: Node; node: Node; resource: Resource) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorScenePostImportPlugin]; T: typedesc) =
  ...
  table["_internal_process"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorScenePostImportPlugin](p_instance).internalProcess(p_args[0].decode(int32), p_args[1].decode(Node), p_args[2].decode(Node), p_args[3].decode(Resource))
...
method save*(self: ResourceFormatSaver; resource: Resource; path: String; flags: uint32): Error {.base.} = (discard)
method setUid*(self: ResourceFormatSaver; path: String; uid: int64): Error {.base.} = (discard)
method recognize*(self: ResourceFormatSaver; resource: Resource): Bool {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ResourceFormatSaver]; T: typedesc) =
  ...
  table["_recognize"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ResourceFormatSaver](p_instance).recognize(p_args[0].decode(Resource)).encode(r_ret)
  table["_get_recognized_extensions"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ResourceFormatSaver](p_instance).getRecognizedExtensions(p_args[0].decode(Resource)).encode(r_ret)
  table["_recognize_path"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ResourceFormatSaver](p_instance).recognizePath(p_args[0].decode(Resource), p_args[1].decode(String)).encode(r_ret)
...
method makeTemplate*(self: ScriptLanguageExtension; `template`: String; className: String; baseClassName: String): Script {.base.} = (discard)
...
method openInExternalEditor*(self: ScriptLanguageExtension; script: Script; line: int32; column: int32): Error {.base.} = (discard)
...
method reloadToolScript*(self: ScriptLanguageExtension; script: Script; softReload: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ScriptLanguageExtension]; T: typedesc) =
  ...
  table["_open_in_external_editor"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).openInExternalEditor(p_args[0].decode(Script), p_args[1].decode(int32), p_args[2].decode(int32)).encode(r_ret)
  ...
  table["_reload_tool_script"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).reloadToolScript(p_args[0].decode(Script), p_args[1].decode(Bool))
...
proc bind_virtuals*(S: typedesc[Control]; T: typedesc) =
  ...
  table["_gui_input"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Control](p_instance).guiInput(p_args[0].decode(InputEvent))

method inputEvent*(self: CollisionObject3D; camera: Camera3D; event: InputEvent; position: Vector3; normal: Vector3; shapeIdx: int32) {.base.} = (discard)
...
method setMultiplayerPeer*(self: MultiplayerAPIExtension; multiplayerPeer: MultiplayerPeer) {.base.} = (discard)
method getMultiplayerPeer*(self: MultiplayerAPIExtension): MultiplayerPeer {.base.} = (discard)
...
method getChildByName*(self: AnimationNode; name: StringName): AnimationNode {.base.} = (discard)
...
method instantiatePlayback*(self: AudioStream): AudioStreamPlayback {.base.} = (discard)
...
method createGizmo*(self: EditorNode3DGizmoPlugin; forNode3d: Node3D): EditorNode3DGizmo {.base.} = (discard)
...
method redraw*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo) {.base.} = (discard)
method getHandleName*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool): String {.base.} = (discard)
method isHandleHighlighted*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool): Bool {.base.} = (discard)
method getHandleValue*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool): Variant {.base.} = (discard)
method setHandle*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool; camera: Camera3D; screenPos: Vector2) {.base.} = (discard)
method commitHandle*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; handleId: int32; secondary: Bool; restore: Variant; cancel: Bool) {.base.} = (discard)
method subgizmosIntersectRay*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; camera: Camera3D; screenPos: Vector2): int32 {.base.} = (discard)
method subgizmosIntersectFrustum*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; camera: Camera3D; frustumPlanes: TypedArray[Plane]): PackedInt32Array {.base.} = (discard)
method getSubgizmoTransform*(self: EditorNode3DGizmoPlugin; gizmo: EditorNode3DGizmo; subgizmoId: int32): Transform3D {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorNode3DGizmoPlugin]; T: typedesc) =
  ...
  table["_redraw"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).redraw(p_args[0].decode(EditorNode3DGizmo))
  table["_get_handle_name"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).getHandleName(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool)).encode(r_ret)
  table["_is_handle_highlighted"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).isHandleHighlighted(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool)).encode(r_ret)
  table["_get_handle_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).getHandleValue(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool)).encode(r_ret)
  table["_set_handle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).setHandle(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool), p_args[3].decode(Camera3D), p_args[4].decode(Vector2))
  table["_commit_handle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).commitHandle(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Bool), p_args[3].decode(Variant), p_args[4].decode(Bool))
  table["_subgizmos_intersect_ray"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).subgizmosIntersectRay(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(Camera3D), p_args[2].decode(Vector2)).encode(r_ret)
  table["_subgizmos_intersect_frustum"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).subgizmosIntersectFrustum(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(Camera3D), p_args[2].decode(TypedArray[Plane])).encode(r_ret)
  table["_get_subgizmo_transform"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).getSubgizmoTransform(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32)).encode(r_ret)
  table["_set_subgizmo_transform"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).setSubgizmoTransform(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(int32), p_args[2].decode(Transform3D))
  table["_commit_subgizmos"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).commitSubgizmos(p_args[0].decode(EditorNode3DGizmo), p_args[1].decode(PackedInt32Array), p_args[2].decode(TypedArray[Transform3D]), p_args[3].decode(Bool))

method importPreflight*(self: GLTFDocumentExtension; state: GLTFState; extensions: PackedStringArray): Error {.base.} = (discard)
method getSupportedExtensions*(self: GLTFDocumentExtension): PackedStringArray {.base.} = (discard)
method parseNodeExtensions*(self: GLTFDocumentExtension; state: GLTFState; gltfNode: GLTFNode; extensions: Dictionary): Error {.base.} = (discard)
method parseImageData*(self: GLTFDocumentExtension; state: GLTFState; imageData: PackedByteArray; mimeType: String; retImage: Image): Error {.base.} = (discard)
method parseTextureJson*(self: GLTFDocumentExtension; state: GLTFState; textureJson: Dictionary; retGltfTexture: GLTFTexture): Error {.base.} = (discard)
method generateSceneNode*(self: GLTFDocumentExtension; state: GLTFState; gltfNode: GLTFNode; sceneParent: Node): Node3D {.base.} = (discard)
method importPostParse*(self: GLTFDocumentExtension; state: GLTFState): Error {.base.} = (discard)
method importNode*(self: GLTFDocumentExtension; state: GLTFState; gltfNode: GLTFNode; json: Dictionary; node: Node): Error {.base.} = (discard)
method importPost*(self: GLTFDocumentExtension; state: GLTFState; root: Node): Error {.base.} = (discard)
method exportPreflight*(self: GLTFDocumentExtension; state: GLTFState; root: Node): Error {.base.} = (discard)
method convertSceneNode*(self: GLTFDocumentExtension; state: GLTFState; gltfNode: GLTFNode; sceneNode: Node) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[GLTFDocumentExtension]; T: typedesc) =
  ...
  table["_parse_node_extensions"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).parseNodeExtensions(p_args[0].decode(GLTFState), p_args[1].decode(GLTFNode), p_args[2].decode(Dictionary)).encode(r_ret)
  table["_parse_image_data"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).parseImageData(p_args[0].decode(GLTFState), p_args[1].decode(PackedByteArray), p_args[2].decode(String), p_args[3].decode(Image)).encode(r_ret)
  table["_parse_texture_json"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).parseTextureJson(p_args[0].decode(GLTFState), p_args[1].decode(Dictionary), p_args[2].decode(GLTFTexture)).encode(r_ret)
  table["_generate_scene_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).generateSceneNode(p_args[0].decode(GLTFState), p_args[1].decode(GLTFNode), p_args[2].decode(Node)).encode(r_ret)
  table["_import_post_parse"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).importPostParse(p_args[0].decode(GLTFState)).encode(r_ret)
  table["_import_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).importNode(p_args[0].decode(GLTFState), p_args[1].decode(GLTFNode), p_args[2].decode(Dictionary), p_args[3].decode(Node)).encode(r_ret)
  table["_import_post"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).importPost(p_args[0].decode(GLTFState), p_args[1].decode(Node)).encode(r_ret)
  table["_export_preflight"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).exportPreflight(p_args[0].decode(GLTFState), p_args[1].decode(Node)).encode(r_ret)
  table["_convert_scene_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).convertSceneNode(p_args[0].decode(GLTFState), p_args[1].decode(GLTFNode), p_args[2].decode(Node))
  table["_export_node"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).exportNode(p_args[0].decode(GLTFState), p_args[1].decode(GLTFNode), p_args[2].decode(Dictionary), p_args[3].decode(Node)).encode(r_ret)
  table["_export_post"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).exportPost(p_args[0].decode(GLTFState)).encode(r_ret)
...
method surfaceSetMaterial*(self: Mesh; index: int32; material: Material) {.base.} = (discard)
method surfaceGetMaterial*(self: Mesh; index: int32): Material {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[Mesh]; T: typedesc) =
  ...
  table["_surface_set_material"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Mesh](p_instance).surfaceSetMaterial(p_args[0].decode(int32), p_args[1].decode(Material))
...
method getTexture*(self: VideoStreamPlayback): Texture2D {.base.} = (discard)
...
method fontSetTextureImage*(self: TextServerExtension; fontRid: RID; size: Vector2i; textureIndex: int64; image: Image) {.base.} = (discard)
method fontGetTextureImage*(self: TextServerExtension; fontRid: RID; size: Vector2i; textureIndex: int64): Image {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[TextServerExtension]; T: typedesc) =
  ...
  table["_font_set_texture_image"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontSetTextureImage(p_args[0].decode(RID), p_args[1].decode(Vector2i), p_args[2].decode(int64), p_args[3].decode(Image))
...
method createDataChannel*(self: WebRTCPeerConnectionExtension; pLabel: String; pConfig: Dictionary): WebRTCDataChannel {.base.} = (discard)
...
method inputEvent*(self: CollisionObject2D; viewport: Viewport; event: InputEvent; shapeIdx: int32) {.base.} = (discard)
...
method getBaseScript*(self: ScriptExtension): Script {.base.} = (discard)
method getGlobalName*(self: ScriptExtension): StringName {.base.} = (discard)
method inheritsScript*(self: ScriptExtension; script: Script): Bool {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ScriptExtension]; T: typedesc) =
  ...
  table["_inherits_script"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).inheritsScript(p_args[0].decode(Script)).encode(r_ret)
