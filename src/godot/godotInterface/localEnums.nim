...
type Vector2_Axis* = enum
  axisX = 0
  axisY = 1
type Vector2i_Axis* = enum
  axisX = 0
  axisY = 1
type Vector3_Axis* = enum
  axisX = 0
  axisY = 1
  axisZ = 2
type Vector3i_Axis* = enum
  axisX = 0
  axisY = 1
  axisZ = 2
type Vector4_Axis* = enum
  axisX = 0
  axisY = 1
  axisZ = 2
  axisW = 3
type Vector4i_Axis* = enum
  axisX = 0
  axisY = 1
  axisZ = 2
  axisW = 3
type Projection_Planes* = enum
  planeNear = 0
  planeFar = 1
  planeLeft = 2
  planeTop = 3
  planeRight = 4
  planeBottom = 5
type Object_ConnectFlags* = enum
  connectDeferred = 1
  connectPersist = 2
  connectOneShot = 4
  connectReferenceCounted = 8

type AudioServer_SpeakerMode* = enum
  speakerModeStereo = 0
  speakerSurround31 = 1
  speakerSurround51 = 2
  speakerSurround71 = 3

type CameraServer_FeedImage* = enum
  feedRgbaImage = 0
  feedCbcrImage = 1
...
type DisplayServer_Feature* = enum
  featureGlobalMenu = 0
  featureSubwindows = 1
...
type DisplayServer_MouseMode* = enum
  mouseModeVisible = 0
  mouseModeHidden = 1
  mouseModeCaptured = 2
  mouseModeConfined = 3
  mouseModeConfinedHidden = 4
type DisplayServer_ScreenOrientation* = enum
  screenLandscape = 0
  screenPortrait = 1
  ...
  screenSensor = 6
type DisplayServer_VirtualKeyboardType* = enum
  ...
  keyboardTypeUrl = 7
type DisplayServer_CursorShape* = enum
  cursorArrow = 0
  cursorIbeam = 1
...
type DisplayServer_WindowFlags* = enum
  ...
  windowFlagMax = 8
type DisplayServer_WindowEvent* = enum
...
type DisplayServer_VSyncMode* = enum
  vsyncDisabled = 0
  vsyncEnabled = 1
  vsyncAdaptive = 2
  vsyncMailbox = 3
type DisplayServer_HandleType* = enum
  displayHandle = 0
  windowHandle = 1
  windowView = 2
  openglContext = 3
type DisplayServer_TTSUtteranceEvent* = enum
  ttsUtteranceStarted = 0
  ttsUtteranceEnded = 1
  ttsUtteranceCanceled = 2
  ttsUtteranceBoundary = 3

type EditorUndoRedoManager_SpecialHistory* = enum
  invalidHistory = -99
  remoteHistory = -9
  globalHistory = 0

type EditorVCSInterface_ChangeType* = enum
  changeTypeNew = 0
...
type EditorVCSInterface_TreeArea* = enum
  treeAreaCommit = 0
  treeAreaStaged = 1
  treeAreaUnstaged = 2

type GDExtensionManager_LoadStatus* = enum
  loadStatusOk = 0
  loadStatusFailed = 1
...
type Geometry2D_PolyBooleanOperation* = enum
  operationUnion = 0
  operationDifference = 1
  operationIntersection = 2
  operationXor = 3
type Geometry2D_PolyJoinType* = enum
  joinSquare = 0
  joinRound = 1
  joinMiter = 2
type Geometry2D_PolyEndType* = enum
  endPolygon = 0
  endJoined = 1
  endButt = 2
  endSquare = 3
...
type Input_MouseMode* = enum
  mouseModeVisible = 0
  mouseModeHidden = 1
  mouseModeCaptured = 2
  mouseModeConfined = 3
  mouseModeConfinedHidden = 4
type Input_CursorShape* = enum
  cursorArrow = 0
  cursorIbeam = 1
  cursorPointingHand = 2
  cursorCross = 3
...
type NavigationServer3D_ProcessInfo* = enum
  infoActiveMaps = 0
  infoRegionCount = 1
  infoAgentCount = 2
  infoLinkCount = 3
...
type Node_DuplicateFlags* = enum
  duplicateSignals = 1
  duplicateGroups = 2
  duplicateScripts = 4
  duplicateUseInstantiation = 8
type Node_InternalMode* = enum
  internalModeDisabled = 0
  internalModeFront = 1
  internalModeBack = 2

type OS_RenderingDriver* = enum
  renderingDriverVulkan = 0
  renderingDriverOpengl3 = 1
type OS_SystemDir* = enum
  systemDirDesktop = 0
  systemDirDcim = 1
...
type PhysicsServer2D_SpaceParameter* = enum
...
type PhysicsServer2D_ShapeType* = enum
  ...
  shapeCustom = 8
type PhysicsServer2D_AreaParameter* = enum
  ...
  areaParamPriority = 9
type PhysicsServer2D_AreaSpaceOverrideMode* = enum
...
type PhysicsServer2D_BodyMode* = enum
  bodyModeStatic = 0
  bodyModeKinematic = 1
  bodyModeRigid = 2
  bodyModeRigidLinear = 3
type PhysicsServer2D_BodyParameter* = enum
  bodyParamBounce = 0
  bodyParamFriction = 1
  bodyParamMass = 2
  bodyParamInertia = 3
  ...
  bodyParamMax = 10
type PhysicsServer2D_BodyDampMode* = enum
  bodyDampModeCombine = 0
  bodyDampModeReplace = 1
type PhysicsServer2D_BodyState* = enum
  bodyStateTransform = 0
  bodyStateLinearVelocity = 1
  bodyStateAngularVelocity = 2
  bodyStateSleeping = 3
  bodyStateCanSleep = 4
type PhysicsServer2D_JointType* = enum
  jointTypePin = 0
  jointTypeGroove = 1
  jointTypeDampedSpring = 2
  jointTypeMax = 3
type PhysicsServer2D_JointParam* = enum
  jointParamBias = 0
  jointParamMaxBias = 1
  jointParamMaxForce = 2
type PhysicsServer2D_PinJointParam* = enum
  pinJointSoftness = 0
type PhysicsServer2D_DampedSpringParam* = enum
  dampedSpringRestLength = 0
  dampedSpringStiffness = 1
  dampedSpringDamping = 2
type PhysicsServer2D_CCDMode* = enum
  ccdModeDisabled = 0
  ccdModeCastRay = 1
  ccdModeCastShape = 2
type PhysicsServer2D_AreaBodyStatus* = enum
  areaBodyAdded = 0
  areaBodyRemoved = 1
type PhysicsServer2D_ProcessInfo* = enum
  infoActiveObjects = 0
  infoCollisionPairs = 1
  infoIslandCount = 2

type PhysicsServer3D_JointType* = enum
  jointTypePin = 0
  jointTypeHinge = 1
  jointTypeSlider = 2
  ...
  jointType6dof = 4
  jointTypeMax = 5
type PhysicsServer3D_PinJointParam* = enum
  pinJointBias = 0
  pinJointDamping = 1
  pinJointImpulseClamp = 2
type PhysicsServer3D_HingeJointParam* = enum
  hingeJointBias = 0
...
type PhysicsServer3D_HingeJointFlag* = enum
  hingeJointFlagUseLimit = 0
  hingeJointFlagEnableMotor = 1
type PhysicsServer3D_SliderJointParam* = enum
...
type PhysicsServer3D_G6DOFJointAxisFlag* = enum
...
type PhysicsServer3D_ShapeType* = enum
  shapeWorldBoundary = 0
  shapeSeparationRay = 1
  shapeSphere = 2
  shapeBox = 3
  ...
  shapeSoftBody = 9
  shapeCustom = 10
type PhysicsServer3D_AreaParameter* = enum
  areaParamGravityOverrideMode = 0
  areaParamGravity = 1
  areaParamGravityVector = 2
  areaParamGravityIsPoint = 3
...
type PhysicsServer3D_AreaSpaceOverrideMode* = enum
  areaSpaceOverrideDisabled = 0
  areaSpaceOverrideCombine = 1
  areaSpaceOverrideCombineReplace = 2
  areaSpaceOverrideReplace = 3
  areaSpaceOverrideReplaceCombine = 4
type PhysicsServer3D_BodyMode* = enum
  bodyModeStatic = 0
  bodyModeKinematic = 1
  bodyModeRigid = 2
  bodyModeRigidLinear = 3
type PhysicsServer3D_BodyParameter* = enum
  bodyParamBounce = 0
  bodyParamFriction = 1
  bodyParamMass = 2
  bodyParamInertia = 3
  ...
  bodyParamAngularDamp = 9
  bodyParamMax = 10
type PhysicsServer3D_BodyDampMode* = enum
  bodyDampModeCombine = 0
  bodyDampModeReplace = 1
type PhysicsServer3D_BodyState* = enum
  bodyStateTransform = 0
  bodyStateLinearVelocity = 1
  bodyStateAngularVelocity = 2
  bodyStateSleeping = 3
  bodyStateCanSleep = 4
type PhysicsServer3D_AreaBodyStatus* = enum
  areaBodyAdded = 0
  areaBodyRemoved = 1
type PhysicsServer3D_ProcessInfo* = enum
  infoActiveObjects = 0
  infoCollisionPairs = 1
  infoIslandCount = 2
type PhysicsServer3D_SpaceParameter* = enum
  spaceParamContactRecycleRadius = 0
  spaceParamContactMaxSeparation = 1
  spaceParamContactMaxAllowedPenetration = 2
  spaceParamContactDefaultBias = 3
...
type PhysicsServer3D_BodyAxis* = enum
  bodyAxisLinearX = 1
  bodyAxisLinearY = 2
  bodyAxisLinearZ = 4
  bodyAxisAngularX = 8
...
type RenderingDevice_DeviceType* = enum
  deviceTypeOther = 0
  ...
  deviceTypeCpu = 4
  deviceTypeMax = 5
type RenderingDevice_DriverResource* = enum
...
type RenderingDevice_DataFormat* = enum
...
type RenderingDevice_TextureType* = enum
  textureType1d = 0
  textureType2d = 1
  textureType3d = 2
  textureTypeCube = 3
  ...
  textureTypeMax = 7
type RenderingDevice_TextureSamples* = enum
  textureSamples1 = 0
  textureSamples2 = 1
  textureSamples4 = 2
  textureSamples8 = 3
...
type RenderingDevice_TextureSwizzle* = enum
  ...
  textureSwizzleA = 6
  textureSwizzleMax = 7
type RenderingDevice_TextureSliceType* = enum
  textureSlice2d = 0
  textureSliceCubemap = 1
  textureSlice3d = 2
type RenderingDevice_SamplerFilter* = enum
  samplerFilterNearest = 0
  samplerFilterLinear = 1
type RenderingDevice_SamplerRepeatMode* = enum
...
type RenderingDevice_SamplerBorderColor* = enum
...
type RenderingDevice_VertexFrequency* = enum
  vertexFrequencyVertex = 0
  vertexFrequencyInstance = 1
type RenderingDevice_IndexBufferFormat* = enum
...
type RenderingDevice_UniformType* = enum
  ...
  uniformTypeMax = 10
type RenderingDevice_RenderPrimitive* = enum
...
type RenderingDevice_PolygonCullMode* = enum
  polygonCullDisabled = 0
  polygonCullFront = 1
  polygonCullBack = 2
type RenderingDevice_PolygonFrontFace* = enum
  polygonFrontFaceClockwise = 0
  polygonFrontFaceCounterClockwise = 1
type RenderingDevice_StencilOperation* = enum
  stencilOpKeep = 0
  stencilOpZero = 1
  stencilOpReplace = 2
  ...
  stencilOpMax = 8
type RenderingDevice_CompareOperator* = enum
  compareOpNever = 0
  compareOpLess = 1
  compareOpEqual = 2
  ...
  compareOpAlways = 7
  compareOpMax = 8
type RenderingDevice_LogicOperation* = enum
  logicOpClear = 0
  logicOpAnd = 1
  logicOpAndReverse = 2
  logicOpCopy = 3
  ...
  logicOpSet = 15
  logicOpMax = 16
type RenderingDevice_BlendFactor* = enum
  blendFactorZero = 0
  blendFactorOne = 1
  ...
  blendFactorMax = 19
type RenderingDevice_BlendOperation* = enum
  blendOpAdd = 0
  blendOpSubtract = 1
...
type RenderingDevice_InitialAction* = enum
  ...
  initialActionMax = 6
type RenderingDevice_FinalAction* = enum
  finalActionRead = 0
  finalActionDiscard = 1
  finalActionContinue = 2
  finalActionMax = 3
type RenderingDevice_ShaderStage* = enum
  shaderStageVertex = 0
...
type RenderingDevice_MemoryType* = enum
  memoryTextures = 0
  memoryBuffers = 1
  memoryTotal = 2

type RenderingServer_TextureLayeredType* = enum
  textureLayered2dArray = 0
  textureLayeredCubemap = 1
  textureLayeredCubemapArray = 2
type RenderingServer_CubeMapLayer* = enum
  cubemapLayerLeft = 0
  cubemapLayerRight = 1
  ...
  cubemapLayerFront = 4
  cubemapLayerBack = 5
type RenderingServer_ShaderMode* = enum
  shaderSpatial = 0
  shaderCanvasItem = 1
  shaderParticles = 2
  shaderSky = 3
  shaderFog = 4
  shaderMax = 5
type RenderingServer_ArrayType* = enum
  arrayVertex = 0
  arrayNormal = 1
  arrayTangent = 2
  arrayColor = 3
  ...
  arrayIndex = 12
  arrayMax = 13
type RenderingServer_ArrayCustomFormat* = enum
...
type RenderingServer_PrimitiveType* = enum
  primitivePoints = 0
  primitiveLines = 1
  ...
  primitiveMax = 5
type RenderingServer_BlendShapeMode* = enum
  blendShapeModeNormalized = 0
  blendShapeModeRelative = 1
type RenderingServer_MultimeshTransformFormat* = enum
  multimeshTransform2d = 0
  multimeshTransform3d = 1
type RenderingServer_LightProjectorFilter* = enum
...
type RenderingServer_LightType* = enum
  lightDirectional = 0
  lightOmni = 1
  lightSpot = 2
type RenderingServer_LightParam* = enum
  lightParamEnergy = 0
...
type RenderingServer_VoxelGIQuality* = enum
  voxelGiQualityLow = 0
  voxelGiQualityHigh = 1
type RenderingServer_ParticlesMode* = enum
  particlesMode2d = 0
  particlesMode3d = 1
type RenderingServer_ParticlesTransformAlign* = enum
...
type RenderingServer_ParticlesCollisionHeightfieldResolution* = enum
...
type RenderingServer_FogVolumeShape* = enum
  ...
  fogVolumeShapeMax = 5
type RenderingServer_ViewportScaling3DMode* = enum
  viewportScaling3dModeBilinear = 0
  viewportScaling3dModeFsr = 1
  viewportScaling3dModeMax = 2
type RenderingServer_ViewportUpdateMode* = enum
...
type RenderingServer_ViewportRenderInfoType* = enum
  viewportRenderInfoTypeVisible = 0
  viewportRenderInfoTypeShadow = 1
  viewportRenderInfoTypeMax = 2
type RenderingServer_ViewportDebugDraw* = enum
...
type RenderingServer_ViewportVRSMode* = enum
  viewportVrsDisabled = 0
  viewportVrsTexture = 1
  viewportVrsXr = 2
  viewportVrsMax = 3
type RenderingServer_SkyMode* = enum
  skyModeAutomatic = 0
  skyModeQuality = 1
  skyModeIncremental = 2
  skyModeRealtime = 3
type RenderingServer_EnvironmentBG* = enum
  envBgClearColor = 0
  envBgColor = 1
  envBgSky = 2
  envBgCanvas = 3
...
type RenderingServer_EnvironmentSDFGIFramesToConverge* = enum
...
type RenderingServer_EnvironmentSDFGIFramesToUpdateLight* = enum
...
type RenderingServer_SubSurfaceScatteringQuality* = enum
...
type RenderingServer_DOFBokehShape* = enum
  dofBokehBox = 0
  dofBokehHexagon = 1
  dofBokehCircle = 2
type RenderingServer_DOFBlurQuality* = enum
  dofBlurQualityVeryLow = 0
  dofBlurQualityLow = 1
  dofBlurQualityMedium = 2
  dofBlurQualityHigh = 3
type RenderingServer_InstanceType* = enum
  instanceNone = 0
  instanceMesh = 1
  instanceMultimesh = 2
  instanceParticles = 3
...
type RenderingServer_InstanceFlags* = enum
...
type RenderingServer_CanvasItemTextureRepeat* = enum
...
type RenderingServer_GlobalShaderParameterType* = enum
  ...
  globalVarTypeMax = 28
type RenderingServer_RenderingInfo* = enum
...
type RenderingServer_Features* = enum
  featureShaders = 0
  featureMultithreaded = 1

type ResourceLoader_ThreadLoadStatus* = enum
  threadLoadInvalidResource = 0
  threadLoadInProgress = 1
  threadLoadFailed = 2
  threadLoadLoaded = 3
type ResourceLoader_CacheMode* = enum
  cacheModeIgnore = 0
  cacheModeReuse = 1
  cacheModeReplace = 2
...
type TreeItem_TreeCellMode* = enum
  cellModeString = 0
  cellModeCheck = 1
  cellModeRange = 2
  cellModeIcon = 3
...
type UndoRedo_MergeMode* = enum
  mergeDisable = 0
  mergeEnds = 1
  mergeAll = 2

type XRServer_TrackerType* = enum
  trackerHead = 1
  trackerController = 2
  ...
  trackerUnknown = 128
  trackerAny = 255
type XRServer_RotationMode* = enum
  resetFullRotation = 0
  resetButKeepTilt = 1
  dontResetRotation = 2

type SceneTree_GroupCallFlags* = enum
  groupCallDefault = 0
  groupCallReverse = 1
  groupCallDeferred = 2
  groupCallUnique = 4

type AnimationPlayer_AnimationProcessCallback* = enum
  animationProcessPhysics = 0
  animationProcessIdle = 1
  animationProcessManual = 2
type AnimationPlayer_AnimationMethodCallMode* = enum
  animationMethodCallDeferred = 0
  animationMethodCallImmediate = 1

type AnimationTree_AnimationProcessCallback* = enum
  animationProcessPhysics = 0
  animationProcessIdle = 1
  animationProcessManual = 2

type AudioStreamPlayer_MixTarget* = enum
  mixTargetStereo = 0
  mixTargetSurround = 1
  mixTargetCenter = 2

type CanvasItem_TextureFilter* = enum
...
type EditorPlugin_DockSlot* = enum
  dockSlotLeftUl = 0
  dockSlotLeftBl = 1
  dockSlotLeftUr = 2
  dockSlotLeftBr = 3
  ...
  dockSlotRightBr = 7
  dockSlotMax = 8
type EditorPlugin_AfterGUIInput* = enum
  afterGuiInputPass = 0
  afterGuiInputStop = 1
  afterGuiInputCustom = 2

type HTTPRequest_Result* = enum
  resultSuccess = 0
...
type MultiplayerSynchronizer_VisibilityUpdateMode* = enum
  visibilityProcessIdle = 0
  visibilityProcessPhysics = 1
  visibilityProcessNone = 2

type Node3D_RotationEditMode* = enum
  rotationEditModeEuler = 0
  rotationEditModeQuaternion = 1
  rotationEditModeBasis = 2

type Timer_TimerProcessCallback* = enum
  timerProcessPhysics = 0
  timerProcessIdle = 1

type Viewport_PositionalShadowAtlasQuadrantSubdiv* = enum
...
type Viewport_Scaling3DMode* = enum
  scaling3dModeBilinear = 0
  scaling3dModeFsr = 1
  scaling3dModeMax = 2
type Viewport_MSAA* = enum
  msaaDisabled = 0
  msaa2x = 1
  msaa4x = 2
  msaa8x = 3
  msaaMax = 4
type Viewport_ScreenSpaceAA* = enum
  screenSpaceAaDisabled = 0
  screenSpaceAaFxaa = 1
  screenSpaceAaMax = 2
type Viewport_RenderInfo* = enum
  renderInfoObjectsInFrame = 0
  renderInfoPrimitivesInFrame = 1
  renderInfoDrawCallsInFrame = 2
  renderInfoMax = 3
type Viewport_RenderInfoType* = enum
  renderInfoTypeVisible = 0
  renderInfoTypeShadow = 1
  renderInfoTypeMax = 2
type Viewport_DebugDraw* = enum
  debugDrawDisabled = 0
  debugDrawUnshaded = 1
  debugDrawLighting = 2
  debugDrawOverdraw = 3
...
type Viewport_DefaultCanvasItemTextureFilter* = enum
...
type Viewport_DefaultCanvasItemTextureRepeat* = enum
...
type AStarGrid2D_Heuristic* = enum
  heuristicEuclidean = 0
  heuristicManhattan = 1
  heuristicOctile = 2
  heuristicChebyshev = 3
  heuristicMax = 4
type AStarGrid2D_DiagonalMode* = enum
...
type CameraFeed_FeedDataType* = enum
  feedNoimage = 0
  feedRgb = 1
  feedYcbcr = 2
  feedYcbcrSep = 3
type CameraFeed_FeedPosition* = enum
  feedUnspecified = 0
  feedFront = 1
  feedBack = 2

type ENetConnection_CompressionMode* = enum
  compressNone = 0
  compressRangeCoder = 1
  compressFastlz = 2
  compressZlib = 3
  compressZstd = 4
type ENetConnection_EventType* = enum
  eventError = -1
  eventNone = 0
  eventConnect = 1
  eventDisconnect = 2
  eventReceive = 3
type ENetConnection_HostStatistic* = enum
  hostTotalSentData = 0
  hostTotalSentPackets = 1
  hostTotalReceivedData = 2
  hostTotalReceivedPackets = 3

type EditorFeatureProfile_Feature* = enum
  feature3d = 0
  featureScript = 1
  featureAssetLib = 2
  featureSceneTree = 3
...
type EditorScenePostImportPlugin_InternalImportCategory* = enum
...
type FileAccess_ModeFlags* = enum
  read = 1
  write = 2
  readWrite = 3
  writeRead = 7
type FileAccess_CompressionMode* = enum
  compressionFastlz = 0
...
type HTTPClient_ResponseCode* = enum
...
type HashingContext_HashType* = enum
  hashMd5 = 0
  hashSha1 = 1
  hashSha256 = 2
...
type MeshConvexDecompositionSettings_Mode* = enum
  convexDecompositionModeVoxel = 0
  convexDecompositionModeTetrahedron = 1

type MultiplayerAPI_RPCMode* = enum
  rpcModeDisabled = 0
  rpcModeAnyPeer = 1
  rpcModeAuthority = 2

type NavigationPathQueryParameters2D_PathfindingAlgorithm* = enum
  pathfindingAlgorithmAstar = 0
type NavigationPathQueryParameters2D_PathPostProcessing* = enum
...
type NavigationPathQueryParameters3D_PathfindingAlgorithm* = enum
  pathfindingAlgorithmAstar = 0
type NavigationPathQueryParameters3D_PathPostProcessing* = enum
  pathPostprocessingCorridorfunnel = 0
  pathPostprocessingEdgecentered = 1
...
type NavigationPathQueryResult2D_PathSegmentType* = enum
  pathSegmentTypeRegion = 0
  pathSegmentTypeLink = 1

type NavigationPathQueryResult3D_PathSegmentType* = enum
  pathSegmentTypeRegion = 0
  pathSegmentTypeLink = 1

type ResourceFormatLoader_CacheMode* = enum
  cacheModeIgnore = 0
  cacheModeReuse = 1
  cacheModeReplace = 2

type ResourceImporter_ImportOrder* = enum
  importOrderDefault = 0
  importOrderScene = 100

type SceneState_GenEditState* = enum
  genEditStateDisabled = 0
  genEditStateInstance = 1
  genEditStateMain = 2
  genEditStateMainInherited = 3

type SurfaceTool_CustomFormat* = enum
  customRgba8Unorm = 0
  customRgba8Snorm = 1
  customRgHalf = 2
  customRgbaHalf = 3
  ...
  customRgbaFloat = 7
  customMax = 8
type SurfaceTool_SkinWeightCount* = enum
  skin4Weights = 0
  skin8Weights = 1

type TextServer_FontAntialiasing* = enum
  fontAntialiasingNone = 0
  fontAntialiasingGray = 1
  fontAntialiasingLcd = 2
type TextServer_FontLCDSubpixelLayout* = enum
...
type TextServer_Direction* = enum
  directionAuto = 0
  directionLtr = 1
  directionRtl = 2
  directionInherited = 3
type TextServer_Orientation* = enum
...
type TextServer_AutowrapMode* = enum
  autowrapOff = 0
  autowrapArbitrary = 1
  autowrapWord = 2
  autowrapWordSmart = 3
...
type TextServer_VisibleCharactersBehavior* = enum
  vcCharsBeforeShaping = 0
  vcCharsAfterShaping = 1
  vcGlyphsAuto = 2
  vcGlyphsLtr = 3
  vcGlyphsRtl = 4
type TextServer_OverrunBehavior* = enum
  overrunNoTrimming = 0
  overrunTrimChar = 1
  overrunTrimWord = 2
...
type TextServer_Hinting* = enum
  hintingNone = 0
  hintingLight = 1
  hintingNormal = 2
type TextServer_SubpixelPositioning* = enum
...
type TextServer_ContourPointTag* = enum
  contourCurveTagOffConic = 0
  contourCurveTagOn = 1
  contourCurveTagOffCubic = 2
type TextServer_SpacingType* = enum
  spacingGlyph = 0
  spacingSpace = 1
  spacingTop = 2
  spacingBottom = 3
...
type TextServer_StructuredTextParser* = enum
...
type GodotThread_Priority* = enum
  priorityLow = 0
  priorityNormal = 1
  priorityHigh = 2

type Tween_TweenProcessMode* = enum
  tweenProcessPhysics = 0
  tweenProcessIdle = 1
type Tween_TweenPauseMode* = enum
  tweenPauseBound = 0
  tweenPauseStop = 1
  tweenPauseProcess = 2
type Tween_TransitionType* = enum
  transLinear = 0
  transSine = 1
  transQuint = 2
  transQuart = 3
  ...
  transBack = 10
  transSpring = 11
type Tween_EaseType* = enum
  easeIn = 0
  easeOut = 1
  easeInOut = 2
  easeOutIn = 3

type UPNP_UPNPResult* = enum
  upnpResultSuccess = 0
...
type UPNPDevice_IGDStatus* = enum
  igdStatusOk = 0
...
type WebRTCPeerConnection_ConnectionState* = enum
  stateNew = 0
  stateConnecting = 1
  stateConnected = 2
  stateDisconnected = 3
  stateFailed = 4
  stateClosed = 5
type WebRTCPeerConnection_GatheringState* = enum
  gatheringStateNew = 0
  gatheringStateGathering = 1
  gatheringStateComplete = 2
type WebRTCPeerConnection_SignalingState* = enum
...
type XRInterface_Capabilities* = enum
  xrNone = 0
  xrMono = 1
  xrStereo = 2
  xrQuad = 4
  ...
  xrAr = 16
  xrExternal = 32
type XRInterface_TrackingStatus* = enum
  xrNormalTracking = 0
  xrExcessiveMotion = 1
  xrInsufficientFeatures = 2
  xrUnknownTracking = 3
  xrNotTracking = 4
type XRInterface_PlayAreaMode* = enum
  xrPlayAreaUnknown = 0
  xrPlayArea3dof = 1
  xrPlayAreaSitting = 2
  xrPlayAreaRoomscale = 3
  xrPlayAreaStage = 4
type XRInterface_EnvironmentBlendMode* = enum
  xrEnvBlendModeOpaque = 0
  xrEnvBlendModeAdditive = 1
  xrEnvBlendModeAlphaBlend = 2

type XRPose_TrackingConfidence* = enum
  xrTrackingConfidenceNone = 0
  xrTrackingConfidenceLow = 1
  xrTrackingConfidenceHigh = 2

type XRPositionalTracker_TrackerHand* = enum
  trackerHandUnknown = 0
  trackerHandLeft = 1
  trackerHandRight = 2

type ZIPPacker_ZipAppend* = enum
  appendCreate = 0
  appendCreateafter = 1
  appendAddinzip = 2

type ScriptLanguageExtension_LookupResultType* = enum
  ...
  lookupResultMax = 9
type ScriptLanguageExtension_CodeCompletionLocation* = enum
  locationLocal = 0
  locationParentMask = 256
  locationOtherUserCode = 512
  locationOther = 1024
type ScriptLanguageExtension_CodeCompletionKind* = enum
...
type Control_FocusMode* = enum
  focusNone = 0
  focusClick = 1
  focusAll = 2
type Control_CursorShape* = enum
  cursorArrow = 0
  cursorIbeam = 1
  cursorPointingHand = 2
  cursorCross = 3
  ...
  cursorHsplit = 15
  cursorHelp = 16
type Control_LayoutPreset* = enum
  presetTopLeft = 0
  presetTopRight = 1
  presetBottomLeft = 2
  presetBottomRight = 3
  ...
  presetFullRect = 15
type Control_LayoutPresetMode* = enum
  presetModeMinsize = 0
...
type Control_MouseFilter* = enum
  mouseFilterStop = 0
  mouseFilterPass = 1
  mouseFilterIgnore = 2
type Control_GrowDirection* = enum
  growDirectionBegin = 0
  growDirectionEnd = 1
  growDirectionBoth = 2
type Control_Anchor* = enum
  anchorBegin = 0
  anchorEnd = 1
type Control_LayoutDirection* = enum
  layoutDirectionInherited = 0
  layoutDirectionLocale = 1
  layoutDirectionLtr = 2
  layoutDirectionRtl = 3
type Control_TextDirection* = enum
  textDirectionAuto = 0
  textDirectionLtr = 1
  textDirectionRtl = 2
  textDirectionInherited = 3

type AudioStreamPlayer3D_AttenuationModel* = enum
  attenuationInverseDistance = 0
  attenuationInverseSquareDistance = 1
  attenuationLogarithmic = 2
  attenuationDisabled = 3
type AudioStreamPlayer3D_DopplerTracking* = enum
  dopplerTrackingDisabled = 0
  dopplerTrackingIdleStep = 1
  dopplerTrackingPhysicsStep = 2

type Camera3D_ProjectionType* = enum
  projectionPerspective = 0
  projectionOrthogonal = 1
  projectionFrustum = 2
type Camera3D_KeepAspect* = enum
  keepWidth = 0
  keepHeight = 1
type Camera3D_DopplerTracking* = enum
  dopplerTrackingDisabled = 0
  dopplerTrackingIdleStep = 1
  dopplerTrackingPhysicsStep = 2

type CollisionObject3D_DisableMode* = enum
  disableModeRemove = 0
  disableModeMakeStatic = 1
  disableModeKeepActive = 2

type OpenXRHand_Hands* = enum
  handLeft = 0
  handRight = 1
  handMax = 2
type OpenXRHand_MotionRange* = enum
  motionRangeUnobstructed = 0
  motionRangeConformToController = 1
  motionRangeMax = 2

type PathFollow3D_RotationMode* = enum
  rotationNone = 0
  rotationY = 1
  rotationXy = 2
  rotationXyz = 3
...
type SubViewport_ClearMode* = enum
  clearModeAlways = 0
  clearModeNever = 1
  clearModeOnce = 2
type SubViewport_UpdateMode* = enum
  updateDisabled = 0
  updateOnce = 1
  updateWhenVisible = 2
...
type Window_Mode* = enum
  modeWindowed = 0
  modeMinimized = 1
  modeMaximized = 2
  modeFullscreen = 3
  modeExclusiveFullscreen = 4
type Window_Flags* = enum
...
type Window_LayoutDirection* = enum
  layoutDirectionInherited = 0
  layoutDirectionLocale = 1
  layoutDirectionLtr = 2
  layoutDirectionRtl = 3
type Window_WindowInitialPosition* = enum
...
type AudioEffectSpectrumAnalyzerInstance_MagnitudeMode* = enum
  magnitudeAverage = 0
  magnitudeMax = 1

type ENetPacketPeer_PeerState* = enum
  stateDisconnected = 0
  stateConnecting = 1
  ...
  stateZombie = 9
type ENetPacketPeer_PeerStatistic* = enum
  peerPacketLoss = 0
...
type WebRTCDataChannel_WriteMode* = enum
  writeModeText = 0
  writeModeBinary = 1
type WebRTCDataChannel_ChannelState* = enum
  stateConnecting = 0
  stateOpen = 1
  stateClosing = 2
  stateClosed = 3

type WebSocketPeer_WriteMode* = enum
  writeModeText = 0
  writeModeBinary = 1
type WebSocketPeer_State* = enum
  stateConnecting = 0
  stateOpen = 1
  stateClosing = 2
  stateClosed = 3

type Animation_TrackType* = enum
  typeValue = 0
  typePosition3d = 1
  typeRotation3d = 2
  typeScale3d = 3
  ...
  typeAudio = 7
  typeAnimation = 8
type Animation_InterpolationType* = enum
  interpolationNearest = 0
  interpolationLinear = 1
  interpolationCubic = 2
  interpolationLinearAngle = 3
  interpolationCubicAngle = 4
type Animation_UpdateMode* = enum
  updateContinuous = 0
  updateDiscrete = 1
  updateCapture = 2
type Animation_LoopMode* = enum
  loopNone = 0
  loopLinear = 1
  loopPingpong = 2
type Animation_LoopedFlag* = enum
  loopedFlagNone = 0
  loopedFlagEnd = 1
  loopedFlagStart = 2
type Animation_FindMode* = enum
  findModeNearest = 0
  findModeApprox = 1
  findModeExact = 2

type AnimationNode_FilterAction* = enum
  filterIgnore = 0
  filterPass = 1
  filterStop = 2
  filterBlend = 3

type AnimationNodeStateMachineTransition_SwitchMode* = enum
  switchModeImmediate = 0
  switchModeSync = 1
  switchModeAtEnd = 2
type AnimationNodeStateMachineTransition_AdvanceMode* = enum
  advanceModeDisabled = 0
  advanceModeEnabled = 1
  advanceModeAuto = 2

type Curve_TangentMode* = enum
  tangentFree = 0
  tangentLinear = 1
  tangentModeCount = 2

type Environment_BGMode* = enum
  bgClearColor = 0
  bgColor = 1
  bgSky = 2
  bgCanvas = 3
...
type Image_UsedChannels* = enum
  ...
  usedChannelsRgb = 4
  usedChannelsRgba = 5
type Image_CompressSource* = enum
  compressSourceGeneric = 0
  compressSourceSrgb = 1
  compressSourceNormal = 2
type Image_ASTCFormat* = enum
  astcFormat4x4 = 0
  astcFormat8x8 = 1

type Mesh_PrimitiveType* = enum
  primitivePoints = 0
  primitiveLines = 1
  primitiveLineStrip = 2
  primitiveTriangles = 3
  primitiveTriangleStrip = 4
type Mesh_ArrayType* = enum
  arrayVertex = 0
  arrayNormal = 1
  arrayTangent = 2
  arrayColor = 3
  ...
  arrayIndex = 12
  arrayMax = 13
type Mesh_ArrayCustomFormat* = enum
  arrayCustomRgba8Unorm = 0
  arrayCustomRgba8Snorm = 1
  arrayCustomRgHalf = 2
  arrayCustomRgbaHalf = 3
...
type Mesh_BlendShapeMode* = enum
  blendShapeModeNormalized = 0
  blendShapeModeRelative = 1

type MultiMesh_TransformFormat* = enum
  transform2d = 0
  transform3d = 1

type NavigationMesh_SamplePartitionType* = enum
  samplePartitionWatershed = 0
  samplePartitionMonotone = 1
  samplePartitionLayers = 2
  samplePartitionMax = 3
type NavigationMesh_ParsedGeometryType* = enum
  parsedGeometryMeshInstances = 0
  parsedGeometryStaticColliders = 1
  parsedGeometryBoth = 2
  parsedGeometryMax = 3
type NavigationMesh_SourceGeometryMode* = enum
  sourceGeometryRootNodeChildren = 0
  sourceGeometryGroupsWithChildren = 1
  sourceGeometryGroupsExplicit = 2
  sourceGeometryMax = 3

type OccluderPolygon2D_CullMode* = enum
  cullDisabled = 0
  cullClockwise = 1
  cullCounterClockwise = 2

type OpenXRAction_ActionType* = enum
  openxrActionBool = 0
  openxrActionFloat = 1
  openxrActionVector2 = 2
  openxrActionPose = 3

type PackedScene_GenEditState* = enum
  genEditStateDisabled = 0
  genEditStateInstance = 1
  genEditStateMain = 2
  genEditStateMainInherited = 3

type Shader_Mode* = enum
  modeSpatial = 0
  modeCanvasItem = 1
  modeParticles = 2
  modeSky = 3
...
type SkeletonProfile_TailDirection* = enum
  tailDirectionAverageChildren = 0
  tailDirectionSpecificChild = 1
  tailDirectionEnd = 2

type Sky_RadianceSize* = enum
  radianceSize32 = 0
  radianceSize64 = 1
  radianceSize128 = 2
  radianceSize256 = 3
...
type TileSet_TileShape* = enum
  tileShapeSquare = 0
  tileShapeIsometric = 1
  tileShapeHalfOffsetSquare = 2
  tileShapeHexagon = 3
type TileSet_TileLayout* = enum
  tileLayoutStacked = 0
...
type TileSet_TileOffsetAxis* = enum
  tileOffsetAxisHorizontal = 0
  tileOffsetAxisVertical = 1
type TileSet_CellNeighbor* = enum
...
type StreamPeerTCP_Status* = enum
  statusNone = 0
  statusConnecting = 1
  statusConnected = 2
  statusError = 3

type StreamPeerTLS_Status* = enum
  statusDisconnected = 0
  statusHandshaking = 1
  statusConnected = 2
  statusError = 3
...
type WebXRInterface_TargetRayMode* = enum
  targetRayModeUnknown = 0
  targetRayModeGaze = 1
  targetRayModeTrackedPointer = 2
  targetRayModeScreen = 3

type BaseButton_DrawMode* = enum
  drawNormal = 0
  drawPressed = 1
  drawHover = 2
  drawDisabled = 3
  drawHoverPressed = 4
type BaseButton_ActionMode* = enum
  actionModeButtonPress = 0
  actionModeButtonRelease = 1

type GraphEdit_PanningScheme* = enum
  scrollZooms = 0
  scrollPans = 1

type ItemList_IconMode* = enum
  iconModeTop = 0
  iconModeLeft = 1
type ItemList_SelectMode* = enum
  selectSingle = 0
  selectMulti = 1

type LineEdit_MenuItems* = enum
  menuCut = 0
  menuCopy = 1
  menuPaste = 2
  menuClear = 3
  ...
  menuInsertShy = 29
  menuMax = 30
type LineEdit_VirtualKeyboardType* = enum
  keyboardTypeDefault = 0
  keyboardTypeMultiline = 1
  keyboardTypeNumber = 2
  keyboardTypeNumberDecimal = 3
...
type NinePatchRect_AxisStretchMode* = enum
  axisStretchModeStretch = 0
  axisStretchModeTile = 1
  axisStretchModeTileFit = 2

type RichTextLabel_ListType* = enum
  listNumbers = 0
  listLetters = 1
  listRoman = 2
  listDots = 3
type RichTextLabel_MenuItems* = enum
  menuCopy = 0
  menuSelectAll = 1
  menuMax = 2

type TabBar_AlignmentMode* = enum
  alignmentLeft = 0
  alignmentCenter = 1
  alignmentRight = 2
  alignmentMax = 3
type TabBar_CloseButtonDisplayPolicy* = enum
  closeButtonShowNever = 0
  closeButtonShowActiveOnly = 1
  closeButtonShowAlways = 2
  closeButtonMax = 3

type TextEdit_MenuItems* = enum
  menuCut = 0
  menuCopy = 1
  menuPaste = 2
  menuClear = 3
  ...
  menuInsertShy = 29
  menuMax = 30
type TextEdit_EditAction* = enum
  actionNone = 0
  actionTyping = 1
  actionBackspace = 2
  actionDelete = 3
type TextEdit_SearchFlags* = enum
  searchMatchCase = 1
  searchWholeWords = 2
  searchBackwards = 4
type TextEdit_CaretType* = enum
  caretTypeLine = 0
  caretTypeBlock = 1
type TextEdit_SelectionMode* = enum
  selectionModeNone = 0
  selectionModeShift = 1
  selectionModePointer = 2
  selectionModeWord = 3
  selectionModeLine = 4
type TextEdit_LineWrappingMode* = enum
  lineWrappingNone = 0
  lineWrappingBoundary = 1
type TextEdit_GutterType* = enum
  gutterTypeString = 0
  gutterTypeIcon = 1
  gutterTypeCustom = 2

type TextureRect_ExpandMode* = enum
  expandKeepSize = 0
  expandIgnoreSize = 1
  expandFitWidth = 2
...
type TextureRect_StretchMode* = enum
  stretchScale = 0
  stretchTile = 1
  stretchKeep = 2
...
type Tree_SelectMode* = enum
  selectSingle = 0
  selectRow = 1
  selectMulti = 2
type Tree_DropModeFlags* = enum
  dropModeDisabled = 0
  dropModeOnItem = 1
  dropModeInbetween = 2

type BackBufferCopy_CopyMode* = enum
  copyModeDisabled = 0
  copyModeRect = 1
  copyModeViewport = 2

type CPUParticles2D_DrawOrder* = enum
  drawOrderIndex = 0
  drawOrderLifetime = 1
type CPUParticles2D_Parameter* = enum
  ...
  paramAnimOffset = 11
  paramMax = 12
type CPUParticles2D_ParticleFlags* = enum
  particleFlagAlignYToVelocity = 0
  particleFlagRotateY = 1
  particleFlagDisableZ = 2
  particleFlagMax = 3
type CPUParticles2D_EmissionShape* = enum
...
type Camera2D_AnchorMode* = enum
  anchorModeFixedTopLeft = 0
  anchorModeDragCenter = 1
type Camera2D_Camera2DProcessCallback* = enum
  camera2dProcessPhysics = 0
  camera2dProcessIdle = 1

type CollisionObject2D_DisableMode* = enum
  disableModeRemove = 0
  disableModeMakeStatic = 1
  disableModeKeepActive = 2

type CollisionPolygon2D_BuildMode* = enum
  buildSolids = 0
  buildSegments = 1

type GPUParticles2D_DrawOrder* = enum
  drawOrderIndex = 0
  drawOrderLifetime = 1
  drawOrderReverseLifetime = 2
type GPUParticles2D_EmitFlags* = enum
  emitFlagPosition = 1
...
type Light2D_ShadowFilter* = enum
  shadowFilterNone = 0
  shadowFilterPcf5 = 1
  shadowFilterPcf13 = 2
type Light2D_BlendMode* = enum
  blendModeAdd = 0
  blendModeSub = 1
  blendModeMix = 2

type Line2D_LineJointMode* = enum
  lineJointSharp = 0
  lineJointBevel = 1
  lineJointRound = 2
type Line2D_LineCapMode* = enum
  lineCapNone = 0
  lineCapBox = 1
  lineCapRound = 2
type Line2D_LineTextureMode* = enum
  lineTextureNone = 0
  lineTextureTile = 1
  lineTextureStretch = 2

type TileMap_VisibilityMode* = enum
  visibilityModeDefault = 0
  visibilityModeForceShow = 1
  visibilityModeForceHide = 2

type TouchScreenButton_VisibilityMode* = enum
  visibilityAlways = 0
  visibilityTouchscreenOnly = 1

type Area3D_SpaceOverride* = enum
...
type ConeTwistJoint3D_Param* = enum
  paramSwingSpan = 0
  paramTwistSpan = 1
  paramBias = 2
  paramSoftness = 3
...
type Generic6DOFJoint3D_Param* = enum
  ...
  paramMax = 22
type Generic6DOFJoint3D_Flag* = enum
...
type HingeJoint3D_Param* = enum
  ...
  paramMax = 8
type HingeJoint3D_Flag* = enum
  flagUseLimit = 0
  flagEnableMotor = 1
  flagMax = 2

type PinJoint3D_Param* = enum
  paramBias = 0
  paramDamping = 1
  paramImpulseClamp = 2

type SliderJoint3D_Param* = enum
...
type GeometryInstance3D_ShadowCastingSetting* = enum
  shadowCastingSettingOff = 0
  shadowCastingSettingOn = 1
  shadowCastingSettingDoubleSided = 2
  shadowCastingSettingShadowsOnly = 3
type GeometryInstance3D_GIMode* = enum
  giModeDisabled = 0
  giModeStatic = 1
  giModeDynamic = 2
type GeometryInstance3D_LightmapScale* = enum
  lightmapScale1x = 0
  lightmapScale2x = 1
  lightmapScale4x = 2
  lightmapScale8x = 3
  lightmapScaleMax = 4
type GeometryInstance3D_VisibilityRangeFadeMode* = enum
  visibilityRangeFadeDisabled = 0
  visibilityRangeFadeSelf = 1
  visibilityRangeFadeDependencies = 2

type Light3D_Param* = enum
  paramEnergy = 0
  ...
  paramIntensity = 20
  paramMax = 21
type Light3D_BakeMode* = enum
  bakeDisabled = 0
  bakeStatic = 1
  bakeDynamic = 2

type LightmapGI_BakeQuality* = enum
  bakeQualityLow = 0
  bakeQualityMedium = 1
  bakeQualityHigh = 2
  bakeQualityUltra = 3
type LightmapGI_GenerateProbes* = enum
  generateProbesDisabled = 0
  generateProbesSubdiv4 = 1
  generateProbesSubdiv8 = 2
  generateProbesSubdiv16 = 3
  generateProbesSubdiv32 = 4
type LightmapGI_BakeError* = enum
  bakeErrorOk = 0
...
type LightmapGI_EnvironmentMode* = enum
  environmentModeDisabled = 0
  environmentModeScene = 1
  environmentModeCustomSky = 2
  environmentModeCustomColor = 3

type ReflectionProbe_UpdateMode* = enum
  updateOnce = 0
  updateAlways = 1
type ReflectionProbe_AmbientMode* = enum
  ambientDisabled = 0
  ambientEnvironment = 1
  ambientColor = 2

type VoxelGI_Subdiv* = enum
  subdiv64 = 0
  subdiv128 = 1
  subdiv256 = 2
  subdiv512 = 3
...
type AudioEffectDistortion_Mode* = enum
  modeClip = 0
  modeAtan = 1
  modeLofi = 2
  modeOverdrive = 3
...
type AudioEffectFilter_FilterDB* = enum
  filter6db = 0
  filter12db = 1
  filter18db = 2
  filter24db = 3

type AudioEffectPitchShift_FFTSize* = enum
  fftSize256 = 0
  fftSize512 = 1
  fftSize1024 = 2
  fftSize2048 = 3
...
type AudioEffectSpectrumAnalyzer_FFTSize* = enum
  fftSize256 = 0
  fftSize512 = 1
  fftSize1024 = 2
  fftSize2048 = 3
...
type AudioStreamRandomizer_PlaybackMode* = enum
  playbackRandomNoRepeats = 0
  playbackRandom = 1
  playbackSequential = 2

type AudioStreamWAV_Format* = enum
  format8Bits = 0
  format16Bits = 1
  formatImaAdpcm = 2
type AudioStreamWAV_LoopMode* = enum
  loopDisabled = 0
  loopForward = 1
  loopPingpong = 2
  loopBackward = 3

type BaseMaterial3D_TextureParam* = enum
  textureAlbedo = 0
  textureMetallic = 1
  textureRoughness = 2
  textureEmission = 3
  ...
  textureOrm = 17
  textureMax = 18
type BaseMaterial3D_TextureFilter* = enum
  ...
  textureFilterMax = 6
type BaseMaterial3D_DetailUV* = enum
  detailUv1 = 0
  detailUv2 = 1
type BaseMaterial3D_Transparency* = enum
  ...
  transparencyMax = 5
type BaseMaterial3D_ShadingMode* = enum
  shadingModeUnshaded = 0
  shadingModePerPixel = 1
  shadingModePerVertex = 2
  shadingModeMax = 3
type BaseMaterial3D_Feature* = enum
  featureEmission = 0
  ...
  featureDetail = 11
  featureMax = 12
type BaseMaterial3D_BlendMode* = enum
  blendModeMix = 0
  blendModeAdd = 1
  blendModeSub = 2
  blendModeMul = 3
type BaseMaterial3D_AlphaAntiAliasing* = enum
  alphaAntialiasingOff = 0
  alphaAntialiasingAlphaToCoverage = 1
  alphaAntialiasingAlphaToCoverageAndToOne = 2
type BaseMaterial3D_DepthDrawMode* = enum
  depthDrawOpaqueOnly = 0
  depthDrawAlways = 1
  depthDrawDisabled = 2
type BaseMaterial3D_CullMode* = enum
  cullBack = 0
  cullFront = 1
  cullDisabled = 2
type BaseMaterial3D_Flags* = enum
  ...
  flagMax = 21
type BaseMaterial3D_DiffuseMode* = enum
  diffuseBurley = 0
  diffuseLambert = 1
  diffuseLambertWrap = 2
  diffuseToon = 3
type BaseMaterial3D_SpecularMode* = enum
  specularSchlickGgx = 0
  specularToon = 1
  specularDisabled = 2
type BaseMaterial3D_BillboardMode* = enum
  billboardDisabled = 0
  billboardEnabled = 1
  billboardFixedY = 2
  billboardParticles = 3
type BaseMaterial3D_TextureChannel* = enum
  textureChannelRed = 0
  textureChannelGreen = 1
  textureChannelBlue = 2
  textureChannelAlpha = 3
  textureChannelGrayscale = 4
type BaseMaterial3D_EmissionOperator* = enum
  emissionOpAdd = 0
  emissionOpMultiply = 1
type BaseMaterial3D_DistanceFadeMode* = enum
  distanceFadeDisabled = 0
  distanceFadePixelAlpha = 1
  distanceFadePixelDither = 2
  distanceFadeObjectDither = 3

type CanvasItemMaterial_BlendMode* = enum
  blendModeMix = 0
  blendModeAdd = 1
  blendModeSub = 2
  blendModeMul = 3
  blendModePremultAlpha = 4
type CanvasItemMaterial_LightMode* = enum
  lightModeNormal = 0
  lightModeUnshaded = 1
  lightModeLightOnly = 2

type ParticleProcessMaterial_Parameter* = enum
  paramInitialLinearVelocity = 0
  paramAngularVelocity = 1
  paramOrbitVelocity = 2
  paramLinearAccel = 3
  ...
  paramMax = 15
type ParticleProcessMaterial_ParticleFlags* = enum
  particleFlagAlignYToVelocity = 0
  particleFlagRotateY = 1
  particleFlagDisableZ = 2
  particleFlagMax = 3
type ParticleProcessMaterial_EmissionShape* = enum
  emissionShapePoint = 0
  emissionShapeSphere = 1
  emissionShapeSphereSurface = 2
  emissionShapeBox = 3
  ...
  emissionShapeRing = 6
  emissionShapeMax = 7
type ParticleProcessMaterial_SubEmitterMode* = enum
  subEmitterDisabled = 0
  subEmitterConstant = 1
  subEmitterAtEnd = 2
  subEmitterAtCollision = 3
  subEmitterMax = 4
type ParticleProcessMaterial_CollisionMode* = enum
  collisionDisabled = 0
  collisionRigid = 1
  collisionHideOnContact = 2
  collisionMax = 3

type FastNoiseLite_NoiseType* = enum
  typeSimplex = 0
  typeSimplexSmooth = 1
  typeCellular = 2
  typePerlin = 3
  typeValueCubic = 4
  typeValue = 5
type FastNoiseLite_FractalType* = enum
  fractalNone = 0
  fractalFbm = 1
  fractalRidged = 2
  fractalPingPong = 3
type FastNoiseLite_CellularDistanceFunction* = enum
  distanceEuclidean = 0
  distanceEuclideanSquared = 1
  distanceManhattan = 2
  distanceHybrid = 3
type FastNoiseLite_CellularReturnType* = enum
  returnCellValue = 0
  returnDistance = 1
  returnDistance2 = 2
...
type VisualShader_Type* = enum
  ...
  typeFog = 9
  typeMax = 10
type VisualShader_VaryingMode* = enum
  varyingModeVertexToFragLight = 0
  varyingModeFragToLight = 1
  varyingModeMax = 2
type VisualShader_VaryingType* = enum
  varyingTypeFloat = 0
  varyingTypeInt = 1
  varyingTypeUint = 2
...
type StyleBoxTexture_AxisStretchMode* = enum
  axisStretchModeStretch = 0
  axisStretchModeTile = 1
  axisStretchModeTileFit = 2

type TextureLayered_LayeredType* = enum
  layeredType2dArray = 0
  layeredTypeCubemap = 1
  layeredTypeCubemapArray = 2

type VisualShaderNodeBillboard_BillboardType* = enum
...
type VisualShaderNodeClamp_OpType* = enum
  opTypeFloat = 0
  opTypeInt = 1
  opTypeUint = 2
  opTypeVector2d = 3
...
type VisualShaderNodeColorFunc_Function* = enum
  funcGrayscale = 0
  funcHsv2rgb = 1
  funcRgb2hsv = 2
  funcSepia = 3
...
type VisualShaderNodeColorOp_Operator* = enum
  opScreen = 0
  opDifference = 1
  opDarken = 2
  opLighten = 3
...
type VisualShaderNodeCompare_ComparisonType* = enum
  ctypeScalar = 0
  ctypeScalarInt = 1
  ctypeScalarUint = 2
  ctypeVector2d = 3
  ...
  ctypeTransform = 7
  ctypeMax = 8
type VisualShaderNodeCompare_Function* = enum
  funcEqual = 0
  funcNotEqual = 1
  funcGreaterThan = 2
  ...
  funcLessThanEqual = 5
  funcMax = 6
type VisualShaderNodeCompare_Condition* = enum
  condAll = 0
  condAny = 1
  condMax = 2

type VisualShaderNodeCubemap_Source* = enum
  sourceTexture = 0
  sourcePort = 1
  sourceMax = 2
type VisualShaderNodeCubemap_TextureType* = enum
  typeData = 0
  typeColor = 1
  typeNormalMap = 2
  typeMax = 3

type VisualShaderNodeDerivativeFunc_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
  opTypeVector3d = 2
  opTypeVector4d = 3
  opTypeMax = 4
type VisualShaderNodeDerivativeFunc_Function* = enum
  funcSum = 0
  funcX = 1
  funcY = 2
  funcMax = 3
type VisualShaderNodeDerivativeFunc_Precision* = enum
  precisionNone = 0
  precisionCoarse = 1
  precisionFine = 2
  precisionMax = 3

type VisualShaderNodeFloatFunc_Function* = enum
  funcSin = 0
  funcCos = 1
  funcTan = 2
  funcAsin = 3
...
type VisualShaderNodeFloatOp_Operator* = enum
  opAdd = 0
  opSub = 1
  opMul = 2
  opDiv = 3
...
type VisualShaderNodeIntFunc_Function* = enum
  funcAbs = 0
  funcNegate = 1
  funcSign = 2
  funcBitwiseNot = 3
...
type VisualShaderNodeIntOp_Operator* = enum
  opAdd = 0
  opSub = 1
  opMul = 2
  opDiv = 3
...
type VisualShaderNodeIs_Function* = enum
  funcIsInf = 0
  funcIsNan = 1
  funcMax = 2

type VisualShaderNodeMix_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
...
type VisualShaderNodeMultiplyAdd_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
  opTypeVector3d = 2
  opTypeVector4d = 3
...
type VisualShaderNodeParameter_Qualifier* = enum
  qualNone = 0
  qualGlobal = 1
  qualInstance = 2
  qualMax = 3

type VisualShaderNodeParticleAccelerator_Mode* = enum
  modeLinear = 0
  modeRadial = 1
  modeTangential = 2
  modeMax = 3

type VisualShaderNodeParticleEmit_EmitFlags* = enum
  emitFlagPosition = 1
  emitFlagRotScale = 2
  emitFlagVelocity = 4
  emitFlagColor = 8
...
type VisualShaderNodeParticleRandomness_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
  opTypeVector3d = 2
  opTypeVector4d = 3
...
type VisualShaderNodeSample3D_Source* = enum
  sourceTexture = 0
  sourcePort = 1
  sourceMax = 2

type VisualShaderNodeSmoothStep_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
  opTypeVector2dScalar = 2
  opTypeVector3d = 3
...
type VisualShaderNodeStep_OpType* = enum
  opTypeScalar = 0
  opTypeVector2d = 1
  opTypeVector2dScalar = 2
  opTypeVector3d = 3
...
type VisualShaderNodeSwitch_OpType* = enum
  opTypeFloat = 0
  opTypeInt = 1
  opTypeUint = 2
  opTypeVector2d = 3
...
type VisualShaderNodeTexture_Source* = enum
  sourceTexture = 0
  sourceScreen = 1
  source2dTexture = 2
  source2dNormal = 3
  ...
  sourceRoughness = 7
  sourceMax = 8
type VisualShaderNodeTexture_TextureType* = enum
  typeData = 0
  typeColor = 1
  typeNormalMap = 2
  typeMax = 3

type VisualShaderNodeTransformFunc_Function* = enum
  funcInverse = 0
  funcTranspose = 1
  funcMax = 2

type VisualShaderNodeTransformOp_Operator* = enum
  opAxb = 0
  opBxa = 1
  opAxbComp = 2
  opBxaComp = 3
...
type VisualShaderNodeTransformVecMult_Operator* = enum
  opAxb = 0
  opBxa = 1
  op3x3Axb = 2
  op3x3Bxa = 3
...
type VisualShaderNodeUIntFunc_Function* = enum
  funcNegate = 0
  funcBitwiseNot = 1
  funcMax = 2

type VisualShaderNodeUIntOp_Operator* = enum
  opAdd = 0
  opSub = 1
  opMul = 2
  opDiv = 3
...
type VisualShaderNodeUVFunc_Function* = enum
  funcPanning = 0
  funcScaling = 1
  funcMax = 2

type VisualShaderNodeVectorBase_OpType* = enum
  opTypeVector2d = 0
  opTypeVector3d = 1
  opTypeVector4d = 2
  opTypeMax = 3

type LinkButton_UnderlineMode* = enum
  underlineModeAlways = 0
  underlineModeOnHover = 1
  underlineModeNever = 2

type TextureButton_StretchMode* = enum
  stretchScale = 0
  stretchTile = 1
  stretchKeep = 2
  stretchKeepCentered = 3
...
type AspectRatioContainer_StretchMode* = enum
  stretchWidthControlsHeight = 0
  stretchHeightControlsWidth = 1
  stretchFit = 2
  stretchCover = 3
type AspectRatioContainer_AlignmentMode* = enum
  alignmentBegin = 0
  alignmentCenter = 1
  alignmentEnd = 2

type BoxContainer_AlignmentMode* = enum
  alignmentBegin = 0
  alignmentCenter = 1
  alignmentEnd = 2

type FlowContainer_AlignmentMode* = enum
  alignmentBegin = 0
  alignmentCenter = 1
  alignmentEnd = 2

type GraphNode_Overlay* = enum
  overlayDisabled = 0
  overlayBreakpoint = 1
  overlayPosition = 2

type ScrollContainer_ScrollMode* = enum
  scrollModeDisabled = 0
  scrollModeAuto = 1
  scrollModeShowAlways = 2
  scrollModeShowNever = 3

type SplitContainer_DraggerVisibility* = enum
  draggerVisible = 0
  draggerHidden = 1
  draggerHiddenCollapsed = 2

type ProgressBar_FillMode* = enum
  fillBeginToEnd = 0
  fillEndToBegin = 1
  fillTopToBottom = 2
  fillBottomToTop = 3

type TextureProgressBar_FillMode* = enum
  fillLeftToRight = 0
  fillRightToLeft = 1
  fillTopToBottom = 2
  fillBottomToTop = 3
...
type CodeEdit_CodeCompletionKind* = enum
  kindClass = 0
  kindFunction = 1
  kindSignal = 2
  kindVariable = 3
  ...
  kindFilePath = 8
  kindPlainText = 9
type CodeEdit_CodeCompletionLocation* = enum
  locationLocal = 0
  locationParentMask = 256
  locationOtherUserCode = 512
  locationOther = 1024

type Area2D_SpaceOverride* = enum
  spaceOverrideDisabled = 0
  spaceOverrideCombine = 1
  spaceOverrideCombineReplace = 2
  spaceOverrideReplace = 3
...
type VisibleOnScreenEnabler2D_EnableMode* = enum
  enableModeInherit = 0
  enableModeAlways = 1
  enableModeWhenPaused = 2

type CharacterBody3D_MotionMode* = enum
  motionModeGrounded = 0
  motionModeFloating = 1
type CharacterBody3D_PlatformOnLeave* = enum
  platformOnLeaveAddVelocity = 0
  platformOnLeaveAddUpwardVelocity = 1
  platformOnLeaveDoNothing = 2

type PhysicalBone3D_DampMode* = enum
  dampModeCombine = 0
  dampModeReplace = 1
type PhysicalBone3D_JointType* = enum
  jointTypeNone = 0
  jointTypePin = 1
  jointTypeCone = 2
  jointTypeHinge = 3
...
type RigidBody3D_FreezeMode* = enum
  freezeModeStatic = 0
  freezeModeKinematic = 1
type RigidBody3D_CenterOfMassMode* = enum
  centerOfMassModeAuto = 0
  centerOfMassModeCustom = 1
type RigidBody3D_DampMode* = enum
  dampModeCombine = 0
  dampModeReplace = 1

type GPUParticlesCollisionHeightField3D_Resolution* = enum
  resolution256 = 0
  resolution512 = 1
  resolution1024 = 2
  resolution2048 = 3
  ...
  resolution8192 = 5
  resolutionMax = 6
type GPUParticlesCollisionHeightField3D_UpdateMode* = enum
  updateModeWhenMoved = 0
  updateModeAlways = 1

type GPUParticlesCollisionSDF3D_Resolution* = enum
  resolution16 = 0
  resolution32 = 1
  resolution64 = 2
  resolution128 = 3
...
type CPUParticles3D_DrawOrder* = enum
  drawOrderIndex = 0
  drawOrderLifetime = 1
  drawOrderViewDepth = 2
type CPUParticles3D_Parameter* = enum
  paramInitialLinearVelocity = 0
  paramAngularVelocity = 1
  paramOrbitVelocity = 2
  paramLinearAccel = 3
  ...
  paramAnimOffset = 11
  paramMax = 12
type CPUParticles3D_ParticleFlags* = enum
  particleFlagAlignYToVelocity = 0
  particleFlagRotateY = 1
  particleFlagDisableZ = 2
  particleFlagMax = 3
type CPUParticles3D_EmissionShape* = enum
  emissionShapePoint = 0
  emissionShapeSphere = 1
  emissionShapeSphereSurface = 2
  emissionShapeBox = 3
...
type CSGShape3D_Operation* = enum
  operationUnion = 0
  operationIntersection = 1
  operationSubtraction = 2

type GPUParticles3D_DrawOrder* = enum
  drawOrderIndex = 0
  drawOrderLifetime = 1
  drawOrderReverseLifetime = 2
  drawOrderViewDepth = 3
type GPUParticles3D_EmitFlags* = enum
  emitFlagPosition = 1
  emitFlagRotationScale = 2
  emitFlagVelocity = 4
  emitFlagColor = 8
  emitFlagCustom = 16
type GPUParticles3D_TransformAlign* = enum
  transformAlignDisabled = 0
  transformAlignZBillboard = 1
  transformAlignYToVelocity = 2
  transformAlignZBillboardYToVelocity = 3

type Label3D_DrawFlags* = enum
  flagShaded = 0
  flagDoubleSided = 1
  flagDisableDepthTest = 2
  flagFixedSize = 3
  flagMax = 4
type Label3D_AlphaCutMode* = enum
  alphaCutDisabled = 0
  alphaCutDiscard = 1
  alphaCutOpaquePrepass = 2
  alphaCutHash = 3

type SpriteBase3D_DrawFlags* = enum
  flagTransparent = 0
  flagShaded = 1
  flagDoubleSided = 2
  ...
  flagFixedSize = 4
  flagMax = 5
type SpriteBase3D_AlphaCutMode* = enum
  alphaCutDisabled = 0
  alphaCutDiscard = 1
  alphaCutOpaquePrepass = 2
  alphaCutHash = 3

type DirectionalLight3D_ShadowMode* = enum
  shadowOrthogonal = 0
  shadowParallel2Splits = 1
  shadowParallel4Splits = 2
type DirectionalLight3D_SkyMode* = enum
  skyModeLightAndSky = 0
  skyModeLightOnly = 1
  skyModeSkyOnly = 2

type OmniLight3D_ShadowMode* = enum
  shadowDualParaboloid = 0
  shadowCube = 1

type VisibleOnScreenEnabler3D_EnableMode* = enum
  enableModeInherit = 0
  enableModeAlways = 1
  enableModeWhenPaused = 2

type AnimationNodeOneShot_OneShotRequest* = enum
  oneShotRequestNone = 0
  oneShotRequestFire = 1
  oneShotRequestAbort = 2
  oneShotRequestFadeOut = 3
type AnimationNodeOneShot_MixMode* = enum
  mixModeBlend = 0
  mixModeAdd = 1

type AnimationNodeAnimation_PlayMode* = enum
  playModeForward = 0
  playModeBackward = 1

type AnimationNodeBlendSpace1D_BlendMode* = enum
  blendModeInterpolated = 0
  blendModeDiscrete = 1
  blendModeDiscreteCarry = 2

type AnimationNodeBlendSpace2D_BlendMode* = enum
  blendModeInterpolated = 0
  blendModeDiscrete = 1
  blendModeDiscreteCarry = 2

type AnimationNodeStateMachine_StateMachineType* = enum
  stateMachineTypeRoot = 0
  stateMachineTypeNested = 1
  stateMachineTypeGrouped = 2

type PlaneMesh_Orientation* = enum
  faceX = 0
  faceY = 1
  faceZ = 2

type RibbonTrailMesh_Shape* = enum
  shapeFlat = 0
  shapeCross = 1

type CurveTexture_TextureMode* = enum
  textureModeRgb = 0
  textureModeRed = 1

type GradientTexture2D_Fill* = enum
  fillLinear = 0
  fillRadial = 1
  fillSquare = 2
type GradientTexture2D_Repeat* = enum
  repeatNone = 0
  repeat = 1
  repeatMirror = 2

type PortableCompressedTexture2D_CompressionMode* = enum
...
type VisualShaderNodeFloatParameter_Hint* = enum
  hintNone = 0
  hintRange = 1
  hintRangeStep = 2
  hintMax = 3

type VisualShaderNodeIntParameter_Hint* = enum
  hintNone = 0
  hintRange = 1
  hintRangeStep = 2
  hintMax = 3

type VisualShaderNodeTextureParameter_TextureType* = enum
  typeData = 0
  typeColor = 1
  typeNormalMap = 2
  typeAnisotropy = 3
  typeMax = 4
type VisualShaderNodeTextureParameter_ColorDefault* = enum
  colorDefaultWhite = 0
  colorDefaultBlack = 1
  colorDefaultTransparent = 2
  colorDefaultMax = 3
type VisualShaderNodeTextureParameter_TextureFilter* = enum
  filterDefault = 0
  filterNearest = 1
  filterLinear = 2
  ...
  filterMax = 7
type VisualShaderNodeTextureParameter_TextureRepeat* = enum
  repeatDefault = 0
  repeatEnabled = 1
  repeatDisabled = 2
  repeatMax = 3
type VisualShaderNodeTextureParameter_TextureSource* = enum
  sourceNone = 0
  sourceScreen = 1
  sourceDepth = 2
...
type VisualShaderNodeVectorFunc_Function* = enum
  funcNormalize = 0
  funcSaturate = 1
  funcNegate = 2
  funcReciprocal = 3
...
type VisualShaderNodeVectorOp_Operator* = enum
  opAdd = 0
  opSub = 1
  opMul = 2
  opDiv = 3
...
type CharacterBody2D_MotionMode* = enum
  motionModeGrounded = 0
  motionModeFloating = 1
type CharacterBody2D_PlatformOnLeave* = enum
  platformOnLeaveAddVelocity = 0
  platformOnLeaveAddUpwardVelocity = 1
  platformOnLeaveDoNothing = 2

type RigidBody2D_FreezeMode* = enum
  freezeModeStatic = 0
  freezeModeKinematic = 1
type RigidBody2D_CenterOfMassMode* = enum
  centerOfMassModeAuto = 0
  centerOfMassModeCustom = 1
type RigidBody2D_DampMode* = enum
  dampModeCombine = 0
  dampModeReplace = 1
type RigidBody2D_CCDMode* = enum
  ccdModeDisabled = 0
  ccdModeCastRay = 1
  ccdModeCastShape = 2

type SoftBody3D_DisableMode* = enum
  disableModeRemove = 0
  disableModeKeepActive = 1

type EditorFileDialog_FileMode* = enum
  fileModeOpenFile = 0
  fileModeOpenFiles = 1
  fileModeOpenDir = 2
  fileModeOpenAny = 3
  fileModeSaveFile = 4
type EditorFileDialog_Access* = enum
  accessResources = 0
  accessUserdata = 1
  accessFilesystem = 2
type EditorFileDialog_DisplayMode* = enum
  displayThumbnails = 0
  displayList = 1

type FileDialog_FileMode* = enum
  fileModeOpenFile = 0
  fileModeOpenFiles = 1
  fileModeOpenDir = 2
  fileModeOpenAny = 3
  fileModeSaveFile = 4
type FileDialog_Access* = enum
  accessResources = 0
  accessUserdata = 1
  accessFilesystem = 2

type ColorPicker_ColorModeType* = enum
  modeRgb = 0
  modeHsv = 1
  modeRaw = 2
  modeOkhsl = 3
type ColorPicker_PickerShapeType* = enum
  shapeHsvRectangle = 0
  shapeHsvWheel = 1
  shapeVhsCircle = 2
  shapeOkhslCircle = 3
...
type CSGPolygon3D_Mode* = enum
  modeDepth = 0
  modeSpin = 1
  modePath = 2
type CSGPolygon3D_PathRotation* = enum
  pathRotationPolygon = 0
  pathRotationPath = 1
  pathRotationPathFollow = 2
type CSGPolygon3D_PathIntervalType* = enum
