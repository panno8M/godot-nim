...
proc `==`*(left: Int; right: Variant): Bool = Equal_Int_Variant(addr left, addr right, addr result)
proc `!=`*(left: Int; right: Variant): Bool = NotEqual_Int_Variant(addr left, addr right, addr result)
proc load_Int_op =
