...
GdString.operators(loader= loadOperators_GdString):
  proc `!=`*(left:GdString; right:GdVariant): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `!=`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `!=`*(left:GdString; right:GdStringName): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `%`*(left:GdString; right:GdVariant): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdBool): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdInt): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdFloat): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdString): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector2): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector2i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdRect2): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdRect2i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector3): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector3i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdTransform2D): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector4): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdVector4i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPlane): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdQuaternion): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdAABB): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdBasis): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdTransform3D): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdProjection): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdColor): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdStringName): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdNodePath): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdObject): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdCallable): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdSignal): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdDictionary): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedByteArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedInt32Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedInt64Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedFloat32Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedFloat64Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedStringArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedVector2Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedVector3Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdString; right:GdPackedColorArray): GdString {.operator: GdVariantOperator.Module.}
  proc `+`*(left:GdString; right:GdString): GdString {.operator: GdVariantOperator.Add.}
  proc `+`*(left:GdString; right:GdStringName): GdString {.operator: GdVariantOperator.Add.}
  proc `<=`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.LessEqual.}
  proc `<`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.Less.}
  proc `==`*(left:GdString; right:GdVariant): GdBool {.operator: GdVariantOperator.Equal.}
  proc `==`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.Equal.}
  proc `==`*(left:GdString; right:GdStringName): GdBool {.operator: GdVariantOperator.Equal.}
  proc `>=`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.GreaterEqual.}
  proc `>`*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.Greater.}
  proc contains*(left:GdString; right:GdString): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdStringName; right:GdString): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdObject; right:GdString): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdDictionary; right:GdString): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdArray; right:GdString): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdPackedStringArray; right:GdString): GdBool {.operator: GdVariantOperator.In.}
