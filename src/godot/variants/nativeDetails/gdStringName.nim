...
GdStringName.operators(loader= loadOperators_GdStringName):
  proc `!=`*(left:GdStringName; right:GdVariant): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `!=`*(left:GdStringName; right:GdString): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `!=`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.NotEqual.}
  proc `%`*(left:GdStringName; right:GdVariant): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdBool): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdInt): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdFloat): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdString): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector2): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector2i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdRect2): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdRect2i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector3): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector3i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdTransform2D): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector4): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdVector4i): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPlane): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdQuaternion): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdAABB): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdBasis): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdTransform3D): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdProjection): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdColor): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdStringName): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdNodePath): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdObject): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdCallable): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdSignal): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdDictionary): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedByteArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedInt32Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedInt64Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedFloat32Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedFloat64Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedStringArray): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedVector2Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedVector3Array): GdString {.operator: GdVariantOperator.Module.}
  proc `%`*(left:GdStringName; right:GdPackedColorArray): GdString {.operator: GdVariantOperator.Module.}
  proc `+`*(left:GdStringName; right:GdString): GdString {.operator: GdVariantOperator.Add.}
  proc `+`*(left:GdStringName; right:GdStringName): GdString {.operator: GdVariantOperator.Add.}
  proc `<=`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.LessEqual.}
  proc `<`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.Less.}
  proc `==`*(left:GdStringName; right:GdVariant): GdBool {.operator: GdVariantOperator.Equal.}
  proc `==`*(left:GdStringName; right:GdString): GdBool {.operator: GdVariantOperator.Equal.}
  proc `==`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.Equal.}
  proc `>=`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.GreaterEqual.}
  proc `>`*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.Greater.}
  proc contains*(left:GdString; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdStringName; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdObject; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdDictionary; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdArray; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
  proc contains*(left:GdPackedStringArray; right:GdStringName): GdBool {.operator: GdVariantOperator.In.}
