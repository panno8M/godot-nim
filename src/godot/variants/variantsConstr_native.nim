...
String.constructors(loader= load_String_constr):
  ...
  converter init*(`from`: String): String {.staticOf: String, index: 1.}
  converter init*(`from`: StringName): String {.staticOf: String, index: 2.}
  converter init*(`from`: NodePath): String {.staticOf: String, index: 3.}
Rect2.constructors(loader= load_Rect2_constr):
  proc init*: Rect2 {.staticOf: Rect2, index: 0.}
  converter init*(`from`: Rect2): Rect2 {.staticOf: Rect2, index: 1.}
  converter init*(`from`: Rect2i): Rect2 {.staticOf: Rect2, index: 2.}
...
Rect2i.constructors(loader= load_Rect2i_constr):
  ...
  converter init*(`from`: Rect2i): Rect2i {.staticOf: Rect2i, index: 1.}
  converter init*(`from`: Rect2): Rect2i {.staticOf: Rect2i, index: 2.}
...
Transform2D.constructors(loader= load_Transform2D_constr):
  ...
  converter init*(`from`: Transform2D): Transform2D {.staticOf: Transform2D, index: 1.}
...
Plane.constructors(loader= load_Plane_constr):
  ...
  converter init*(`from`: Plane): Plane {.staticOf: Plane, index: 1.}
  converter init*(normal: Vector3): Plane {.staticOf: Plane, index: 2.}
...
Quaternion.constructors(loader= load_Quaternion_constr):
  ...
  converter init*(`from`: Quaternion): Quaternion {.staticOf: Quaternion, index: 1.}
  converter init*(`from`: Basis): Quaternion {.staticOf: Quaternion, index: 2.}
...
AABB.constructors(loader= load_AABB_constr):
  ...
  converter init*(`from`: AABB): AABB {.staticOf: AABB, index: 1.}
...
Basis.constructors(loader= load_Basis_constr):
  ...
  converter init*(`from`: Basis): Basis {.staticOf: Basis, index: 1.}
  converter init*(`from`: Quaternion): Basis {.staticOf: Basis, index: 2.}
...
Transform3D.constructors(loader= load_Transform3D_constr):
  ...
  converter init*(`from`: Transform3D): Transform3D {.staticOf: Transform3D, index: 1.}
  ...
  converter init*(`from`: Projection): Transform3D {.staticOf: Transform3D, index: 4.}
Projection.constructors(loader= load_Projection_constr):
  proc init*: Projection {.staticOf: Projection, index: 0.}
  converter init*(`from`: Projection): Projection {.staticOf: Projection, index: 1.}
  converter init*(`from`: Transform3D): Projection {.staticOf: Projection, index: 2.}
...
Color.constructors(loader= load_Color_constr):
  ...
  converter init*(`from`: Color): Color {.staticOf: Color, index: 1.}
  ...
  converter init*(code: String): Color {.staticOf: Color, index: 5.}
...
StringName.constructors(loader= load_StringName_constr):
  ...
  converter init*(`from`: StringName): StringName {.staticOf: StringName, index: 1.}
  converter init*(`from`: String): StringName {.staticOf: StringName, index: 2.}
NodePath.constructors(loader= load_NodePath_constr):
  proc init*: NodePath {.staticOf: NodePath, index: 0.}
  converter init*(`from`: NodePath): NodePath {.staticOf: NodePath, index: 1.}
  converter init*(`from`: String): NodePath {.staticOf: NodePath, index: 2.}
RID.constructors(loader= load_RID_constr):
  proc init*: RID {.staticOf: RID, index: 0.}
  converter init*(`from`: RID): RID {.staticOf: RID, index: 1.}
Callable.constructors(loader= load_Callable_constr):
  proc init*: Callable {.staticOf: Callable, index: 0.}
  converter init*(`from`: Callable): Callable {.staticOf: Callable, index: 1.}
...
Signal.constructors(loader= load_Signal_constr):
  ...
  converter init*(`from`: Signal): Signal {.staticOf: Signal, index: 1.}
...
Dictionary.constructors(loader= load_Dictionary_constr):
  ...
  converter init*(`from`: Dictionary): Dictionary {.staticOf: Dictionary, index: 1.}
Array.constructors(loader= load_Array_constr):
  proc init*: Array {.staticOf: Array, index: 0.}
  converter init*(`from`: Array): Array {.staticOf: Array, index: 1.}
  proc init*(base: Array; `type`: Int; className: StringName; script: ptr Variant): Array {.staticOf: Array, index: 2.}
  converter init*(`from`: PackedByteArray): Array {.staticOf: Array, index: 3.}
  converter init*(`from`: PackedInt32Array): Array {.staticOf: Array, index: 4.}
  converter init*(`from`: PackedInt64Array): Array {.staticOf: Array, index: 5.}
  converter init*(`from`: PackedFloat32Array): Array {.staticOf: Array, index: 6.}
  converter init*(`from`: PackedFloat64Array): Array {.staticOf: Array, index: 7.}
  converter init*(`from`: PackedStringArray): Array {.staticOf: Array, index: 8.}
  converter init*(`from`: PackedVector2Array): Array {.staticOf: Array, index: 9.}
  converter init*(`from`: PackedVector3Array): Array {.staticOf: Array, index: 10.}
  converter init*(`from`: PackedColorArray): Array {.staticOf: Array, index: 11.}
PackedByteArray.constructors(loader= load_PackedByteArray_constr):
  ...
  converter init*(`from`: PackedByteArray): PackedByteArray {.staticOf: PackedByteArray, index: 1.}
  converter init*(`from`: Array): PackedByteArray {.staticOf: PackedByteArray, index: 2.}
PackedInt32Array.constructors(loader= load_PackedInt32Array_constr):
  ...
  converter init*(`from`: PackedInt32Array): PackedInt32Array {.staticOf: PackedInt32Array, index: 1.}
  converter init*(`from`: Array): PackedInt32Array {.staticOf: PackedInt32Array, index: 2.}
PackedInt64Array.constructors(loader= load_PackedInt64Array_constr):
  ...
  converter init*(`from`: PackedInt64Array): PackedInt64Array {.staticOf: PackedInt64Array, index: 1.}
  converter init*(`from`: Array): PackedInt64Array {.staticOf: PackedInt64Array, index: 2.}
PackedFloat32Array.constructors(loader= load_PackedFloat32Array_constr):
  ...
  converter init*(`from`: PackedFloat32Array): PackedFloat32Array {.staticOf: PackedFloat32Array, index: 1.}
  converter init*(`from`: Array): PackedFloat32Array {.staticOf: PackedFloat32Array, index: 2.}
PackedFloat64Array.constructors(loader= load_PackedFloat64Array_constr):
  ...
  converter init*(`from`: PackedFloat64Array): PackedFloat64Array {.staticOf: PackedFloat64Array, index: 1.}
  converter init*(`from`: Array): PackedFloat64Array {.staticOf: PackedFloat64Array, index: 2.}
PackedStringArray.constructors(loader= load_PackedStringArray_constr):
  ...
  converter init*(`from`: PackedStringArray): PackedStringArray {.staticOf: PackedStringArray, index: 1.}
  converter init*(`from`: Array): PackedStringArray {.staticOf: PackedStringArray, index: 2.}
PackedVector2Array.constructors(loader= load_PackedVector2Array_constr):
  ...
  converter init*(`from`: PackedVector2Array): PackedVector2Array {.staticOf: PackedVector2Array, index: 1.}
  converter init*(`from`: Array): PackedVector2Array {.staticOf: PackedVector2Array, index: 2.}
PackedVector3Array.constructors(loader= load_PackedVector3Array_constr):
  ...
  converter init*(`from`: PackedVector3Array): PackedVector3Array {.staticOf: PackedVector3Array, index: 1.}
  converter init*(`from`: Array): PackedVector3Array {.staticOf: PackedVector3Array, index: 2.}
PackedColorArray.constructors(loader= load_PackedColorArray_constr):
  ...
  converter init*(`from`: PackedColorArray): PackedColorArray {.staticOf: PackedColorArray, index: 1.}
  converter init*(`from`: Array): PackedColorArray {.staticOf: PackedColorArray, index: 2.}