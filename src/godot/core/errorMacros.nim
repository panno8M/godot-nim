...
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError: cstring; pEditorNotify = false; pIsWarning = false) {.error.}
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError: ptr GdString; pEditorNotify = false; pIsWarning = false) {.error.}
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError, pMessage: cstring; pEditorNotify = false; pIsWarning = false) {.error.}
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError: ptr GdString; pMessage: cstring; pEditorNotify = false; pIsWarning = false) {.error.}
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError: cstring; pMessage: ptr GdString; pEditorNotify = false; pIsWarning = false)  {.error.}
proc errPrintError(pFunction, pFile: cstring; pLine: cint; pError, pMessage: ptr GdString; pEditorNotify = false; pIsWarning = false) {.error.}
proc errPrintIndexError(pFunction, pFile: cstring; pLine: cint; pIndex, pSize: int64; pIndexStr, pSizeStr: cstring; pMessage: cstring = ""; pEditorNotify = false; pFatal = false) {.error.}
proc errPrintIndexError(pFunction, pFile: cstring; pLine: cint; pIndex, pSize: int64; pIndexStr, pSizeStr: cstring; pMessage: ptr GdString; pEditorNotify = false; pFatal = false) {.error.}
proc errFlushStdout() {.error.}
