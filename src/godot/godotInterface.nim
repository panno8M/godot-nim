...
type SomeGdPackedArray* =
  GdPackedByteArray    |
  GdPackedInt32Array   |
  GdPackedInt64Array   |
  GdPackedFloat32Array |
  GdPackedFloat64Array |
  GdPackedStringArray  |
  GdPackedVector2Array |
  GdPackedVector3Array |
  GdPackedColorArray
type SomeGdFloatVector* =
  GdVector2 |
  GdVector3 |
  GdVector4
type SomeGdIntVector* =
  GdVector2i |
  GdVector3i |
  GdVector4i
...
proc `=copy`(a: var GdVariant; b: GdVariant) =
  if a == b: return
  {.warning: "now, `=copy`(GdVariant) will not destroy current reference.".}
  wasMoved(a)
  gdinterface.variantNewCopy(addr a, unsafeAddr b)